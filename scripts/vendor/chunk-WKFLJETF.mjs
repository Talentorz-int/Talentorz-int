import { a as Ct, e as At, h as Ot, i as Dt } from "chunk-WJBO7C5H.mjs";
import { E as vt, F as Rt, L as Hn, W as $n, X as Nt, Y as Gn, ia as jn } from "chunk-3GX5YKYT.mjs";
...
function zn(e) {
  ...
  return (
    ...
    t
      .slice(0, 50)
      .map((n) => ({ ...n, filename: n.filename || Fe(t).filename, function: n.function || W }))
  );
}
function Fe(e) {
  return e[e.length - 1] || {};
...
function ae(e) {
  return typeof Event < "u" && Y(e, Event);
}
function Ft(e) {
  return typeof Element < "u" && Y(e, Element);
}
function Ut(e) {
  return le(e, "RegExp");
}
...
function ve(e, t = {}) {
  ...
  try {
    ...
    for (
      ...
      n &&
      i++ < r &&
      ((u = Co(n, p)), !(u === "html" || (i > 1 && s + o.length * c + u.length >= l)));
    )
...
function Jn(e, t, n = !1) {
  return C(e) ? (Ut(t) ? t.test(e) : C(t) ? (n ? e === t : e.includes(t)) : !1) : !1;
}
function me(e, t = [], n = !1) {
...
function qe(e) {
  ...
  if (ae(e)) {
    ...
    return (typeof CustomEvent < "u" && Y(e, CustomEvent) && (t.detail = e.detail), t);
  } else return e;
}
function Vn(e) {
  try {
...
function Wt(e, t = 40) {
  ...
  if (r.length >= t) return z(r, t);
  for (let o = n.length; o > 0; o--) {
    let i = n.slice(0, o).join(", ");
    if (!(i.length > t)) return o === n.length ? i : z(i, t);
  }
  return "";
}
function y(e) {
...
function tr(e, t) {
  let n = {};
  (t ? (n = { status: t }) : e.status === "ok" && (n = { status: "exited" }), Q(e, n));
}
function wo(e) {
  return y({
    sid: `${e.sid}`,
  ...
  Jt = class e {
    ...
    setUser(t) {
      return (
        ...
        this._session && Q(this._session, { user: t }),
...
function br(e, t, n, r) {
  ...
  ni(e, n && n.sdk);
  let s = un(e, o, r, t);
  return (delete e.sdkProcessingMetadata, K(s, [[{ type: i }, e]]));
}
...
function Cr(e, t, n, r, o, i) {
  let { normalizeDepth: s = 3, normalizeMaxBreadth: a = 1e3 } = e,
    c = { ...t, event_id: t.event_id || n.event_id || b(), timestamp: t.timestamp || q() },
...
function Te(e, t) {
  return O().captureException(e, Ar(t));
}
function Ce(e, t) {
...
function Ae(e) {
  let t = S(),
    ...
    c = n.getSession();
  return (
    c && c.status === "ok" && Q(c, { status: "exited" }),
    st(),
    n.setSession(a),
    r.setSession(a),
    a
...
function Ur(e, t, n) {
  let r = [{ type: "client_report" }, { timestamp: n || q(), discarded_events: e }];
  return K(t ? { dsn: t } : {}, [r]);
}
...
var Br = "Not capturing exception because it's already been captured.",
  De = class {
    ...
    _updateSessionFromEvent(t, n) {
      ...
      let s = t.status === "ok";
      ((s && t.errors === 0) || (s && r)) &&
        (Q(t, { ...(r && { status: "crashed" }), errors: t.errors || Number(o || r) }),
...
Reason: ${h}`));
    ...
    _flushOutcomes() {
      ...
      let n = Ur(t, this._options.tunnel && ee(this._dsn));
      this.sendEnvelope(n);
    }
  };
function Ii(e, t) {
...
function Gr(e) {
  ...
  function o(s) {
    if (!n()) return re(new D("Not adding Promise because buffer limit was reached."));
    let a = s();
    return (
...
function Sn(e, t, n = 250, r, o, i, s) {
  if (!i.exception || !i.exception.values || !s || !Y(s.originalException, Error)) return;
  let a =
...
function ji(e, t) {
  return e.map((n) => (n.value && (n.value = z(n.value, t)), n));
}
function we(e) {
  if (!e) return {};
  let t = e.match(/^(([^:/?#]+):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?$/);
        ...
        return n.apply(d, r).then(
          ...
          (c) => {
            throw (
              ...
              ie(c) && c.stack === void 0 && ((c.stack = a), A(c, "framesToPop", 1)),
              c
            );
          }
        );
...
function ue(e, t = {}, n) {
    ...
    try {
      ...
      throw (
        ...
        Ee((s) => {
          (s.addEventProcessor(
            (a) => (
              t.mechanism && (ge(a, void 0, void 0), X(a, t.mechanism)),
  ...
  (ze(r, e), A(e, "__sentry_wrapped__", r));
  try {
...
var te = typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__;
function ht(e, t) {
  let n = wn(e, t),
...
function to(e, t, n, r) {
  let o = (n && n.syntheticException) || void 0,
    i = _t(e, t, o, r);
  return (X(i), (i.level = "error"), n && n.event_id && (i.event_id = n.event_id), U(i));
}
...
function _t(e, t, n, r, o) {
  ...
  return ie(t)
    ? On(e, t)
    : H(t) || ae(t)
      ? ((i = as(e, t, n, o)), X(i, { synthetic: !0 }), i)
      : ((i = Dn(e, t, n, r)), ge(i, `${t}`, void 0), X(i, { synthetic: !0 }), i);
}
function Dn(e, t, n, r) {
  let o = {};
  if (r && n) {
...
var Et = class extends De {
  ...
  captureUserFeedback(t) {
    if (!this._isEnabled()) {
      te && f.warn("SDK not enabled, will not capture user feedback.");
      return;
    }
    let n = ro(t, {
...
function so(e, t = !1) {
  return (n) => {
    ...
    (A(n, "_sentryCaptured", !0), r && !r._sentryId && A(r, "_sentryId", b()));
...
function xs() {
  ...
  ((e.open = new Proxy(e.open, {
    apply(t, n, r) {
      let o = k() * 1e3,
        i = C(r[0]) ? r[0].toUpperCase() : void 0,
        s = bs(r[1]);
      ...
      return (
        ...
        (n.setRequestHeader = new Proxy(n.setRequestHeader, {
          apply(c, u, p) {
            let [l, g] = p,
              E = u[pe];
            return (E && C(l) && C(g) && (E.request_headers[l.toLowerCase()] = g), c.apply(u, p));
          },
        })),
        t.apply(n, r)
      );
...
function ao(e, t = Ln("fetch")) {
  ...
  function o(i) {
    ...
    if (!t) return (Tt("fetch"), re("No fetch implementation available"));
    try {
...
var Rs = 50;
function Un(e, t, n, r) {
  let o = { filename: e, function: t === "<anonymous>" ? W : t, in_app: !0 };
...
function Hs(e, t) {
  return function (r) {
    ...
    (i && (c.data = { "ui.component_name": i }),
      J(c, { event: r.event, name: r.name, global: r.global }));
  };
}
function $s(e) {
  return function (n) {
    ...
    J(r, { input: n.args, level: n.level });
  };
}
function Gs(e) {
  return function (n) {
    ...
    let { method: s, url: a, status_code: c, body: u } = i,
      ...
      g = lt(c);
    J({ category: "xhr", data: p, type: "http", level: g }, l);
  };
}
function js(e) {
  return function (n) {
...
function Ws(e) {
  return function (n) {
    ...
    ((!s || !s.path) && (s = i),
      ...
      J({ category: "navigation", data: { from: r, to: o } }));
  };
}
function Ys(e) {
  return !!e && !!e.target;
...
function ea(e) {
  Pt((t) => {
    ...
    ((u.level = "error"),
      Ce(u, { originalException: c, mechanism: { handled: !1, type: "onerror" } }));
  });
}
function ta(e) {
  Mt((t) => {
    ...
    ((i.level = "error"),
      Ce(i, { originalException: o, mechanism: { handled: !1, type: "onunhandledrejection" } }));
  });
}
function na(e) {
  if (se(e)) return e;
...
function oa(e, t, n, r) {
  let o = (e.exception = e.exception || {}),
    ...
    l = C(t) && t.length > 0 ? t : $t();
  return (
    c.length === 0 && c.push({ colno: u, filename: l, function: W, in_app: !0, lineno: p }),
    e
  );
}
function mo(e) {
  te && f.log(`Global Handler attached: ${e}`);
}
function ho() {
  let e = S();
...
function la() {
  ...
  (Ae({ ignoreDuration: !0 }),
    Oe(),
    Pe(({ from: e, to: t }) => {
      e !== void 0 && e !== t && (Ae({ ignoreDuration: !0 }), Oe());
    }));
}
var ma = "__debugPerformance",
  ga = typeof window < "u" ? window.location : void 0,
  yo = new URLSearchParams(ga?.search).has(ma),
  To = !1,
  ha = typeof window < "u" ? window.navigator : void 0,
  _a = ha?.userAgent || "",
  xt = window;
function Ea() {
...
function og({ name: e, security: t }) {
  To ||
    ...
    window.addEventListener("pagehide", () => {
      (it(),
        Ct.log.debug("Unregistering services to parent/opener frame when unloading"),
        At.shared().unregister(Ot).catch(Nt),
        At.shared().unregister(Dt).catch(Nt));
    }));
}
export {
  Ee as a,
...
//# sourceMappingURL=chunk-WKFLJETF.mjs.map
