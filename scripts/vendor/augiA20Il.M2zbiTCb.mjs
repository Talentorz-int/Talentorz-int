...
import { n as t, t as n } from "./shared-lib.3vyoKFC0.mjs";
function r(e, n) {
  return {
    breakpoints: [
      { hash: `72rtr7`, mediaQuery: `(min-width: 1200px)` },
      { hash: `2wwrl6`, mediaQuery: `(min-width: 810px) and (max-width: 1199.98px)` },
      { hash: `1at3fs`, mediaQuery: `(max-width: 809.98px)` },
    ],
    description: t(e, n).description,
    elements: {},
    robots: `max-image-preview:large`,
    serializationId: `framer-xnFBN`,
...
//# sourceMappingURL=augiA20Il.M2zbiTCb.mjs.map
