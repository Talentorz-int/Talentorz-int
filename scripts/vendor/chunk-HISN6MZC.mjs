import { Iu as N, Ku as P, at as H, kg as b, u as l } from "chunk-C45BQYIA.mjs";
import { a as C, f as m, h as S, l as h } from "chunk-DYNCKUFC.mjs";
...
function u(d, o, e) {
  if (h(d.hidden)) return !1;
  if (C(d.hidden)) return d.hidden;
  try {
    j();
    let t = d.hidden(o, e);
    return (v(), t);
...
var R = class {
  ...
  async getHiddenStateForControlsByNode(o) {
    ...
    return (
      Object.entries(o).forEach(([t, { controlNames: n }]) => {
        ...
        if (!r) return;
        f(H(r), "Node is not a CanvasNode with control props (node.__class: ", r.__class, ")");
  ...
  async getHiddenStateForActionControls({ actionIdentifier: o, controlNames: e, actionProps: t }) {
    ...
    return e.reduce((i, s) => {
      ...
      return a ? ((i[s] = u(a, t, t)), i) : ((i[s] = !1), i);
    }, {});
  }
  async getHiddenStateForModuleControls({ moduleIdentifier: o, controlNames: e, moduleProps: t }) {
    ...
    return x(e ?? Object.keys(n), n, N(n, t, r));
  }
};
function y(d, o, e, t, n, r) {
  let i = d + o;
  if (e) {
    if ((e.hidden && (r[i] = u(e, t, n)), e.type === "object")) {
      let s = t[o];
      if (!m(s)) return;
...
export { w as a, R as b };
//# sourceMappingURL=chunk-HISN6MZC.mjs.map
