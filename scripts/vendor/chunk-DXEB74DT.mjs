    ...
    v = g(
      (e =
        (a =
          ...
          ? a
          : (s = x.locale) === null || s === void 0 || (l = s.options) === null || l === void 0
            ? void 0
            : l.firstWeekContainsDate) !== null && e !== void 0
        ? e
        : 1
    );
  if (!(v >= 1 && v <= 7))
...
var ft = {
    y: function (t, e) {
      var a = t.getUTCFullYear(),
        o = a > 0 ? a : 1 - a;
      return m(e === "yy" ? o % 100 : o, e.length);
    },
    M: function (t, e) {
      var a = t.getUTCMonth();
      return e === "M" ? String(a + 1) : m(a + 1, 2);
    },
    d: function (t, e) {
...
var E = {
  ...
  st = {
    ...
    Y: function (t, e, a, o) {
      ...
      return e === "Yo" ? a.ordinalNumber(i, { unit: "year" }) : m(i, e.length);
    },
    R: function (t, e) {
      var a = R(t);
      return m(a, e.length);
    ...
    w: function (t, e, a, o) {
      var n = se(t, o);
      return e === "wo" ? a.ordinalNumber(n, { unit: "week" }) : m(n, e.length);
    },
    I: function (t, e, a) {
      var o = ie(t);
      return e === "Io" ? a.ordinalNumber(o, { unit: "week" }) : m(o, e.length);
    },
    d: function (t, e, a) {
    ...
    D: function (t, e, a) {
      var o = oe(t);
      return e === "Do" ? a.ordinalNumber(o, { unit: "dayOfYear" }) : m(o, e.length);
    },
    E: function (t, e, a) {
      var o = t.getUTCDay();
      switch (e) {
    ...
    K: function (t, e, a) {
      var o = t.getUTCHours() % 12;
      return e === "Ko" ? a.ordinalNumber(o, { unit: "hour" }) : m(o, e.length);
    },
    k: function (t, e, a) {
      var o = t.getUTCHours();
      return (
        o === 0 && (o = 24),
        e === "ko" ? a.ordinalNumber(o, { unit: "hour" }) : m(o, e.length)
      );
    },
    m: function (t, e, a) {
...
function Ie(r, t) {
  ...
  var i = t || "";
  return e + String(o) + i + m(n, 2);
}
function ke(r, t) {
  if (r % 60 === 0) {
    var e = r > 0 ? "-" : "+";
    return e + m(Math.abs(r) / 60, 2);
  }
  return N(r, t);
}
function N(r, t) {
...
var vt = { full: "EEEE, MMMM do, y", long: "MMMM do, y", medium: "MMM d, y", short: "MM/dd/yyyy" },
  ht = { full: "h:mm:ss a zzzz", long: "h:mm:ss a z", medium: "h:mm:ss a", short: "h:mm a" },
  gt = {
    full: "{{date}} 'at' {{time}}",
    long: "{{date}} 'at' {{time}}",
    medium: "{{date}}, {{time}}",
  ...
  xt = {
    ...
    time: $({ formats: ht, defaultWidth: "full" }),
    dateTime: $({ formats: gt, defaultWidth: "full" }),
  },
  Ee = xt;
var wt = {
...
var Dt = { narrow: ["B", "A"], abbreviated: ["BC", "AD"], wide: ["Before Christ", "Anno Domini"] },
  Tt = {
    narrow: ["1", "2", "3", "4"],
  ...
  kt = {
    ordinalNumber: It,
    era: U({ values: Dt, defaultWidth: "wide" }),
    quarter: U({
      values: Tt,
      defaultWidth: "wide",
    ...
    month: U({ values: Ot, defaultWidth: "wide" }),
    day: U({ values: bt, defaultWidth: "wide" }),
    dayPeriod: U({
      values: Mt,
      defaultWidth: "wide",
      formattingValues: St,
...
function P(r) {
  return function (t) {
    ...
    var i = n[0],
      ...
      l;
    ((l = r.valueCallback ? r.valueCallback(s) : s),
...
var Yt = /^(\d+)(th|st|nd|rd)?/i,
  ...
  Pt = { any: [/^b/i, /^(a|c)/i] },
  _t = { narrow: /^[1234]/i, abbreviated: /^q[1234]/i, wide: /^[1234](th|st|nd|rd)? quarter/i },
  Et = { any: [/1/i, /2/i, /3/i, /4/i] },
  qt = {
    narrow: /^[jfmasond]/i,
...
var Xt = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,
  ...
  jt = /[a-zA-Z]/;
function Re(r, t, e) {
  var a, o, n, i, d, s, l, c, p, x, v, h, D, y, O, S, b, F;
  f(2, arguments);
  var Z = String(t),
    W = T(),
    Y =
  ...
  var Ke = q(B),
    et = ae(B, Ke),
    tt = { firstWeekContainsDate: K, weekStartsOn: ee, locale: Y, _originalDate: B },
    rt = Z.match(Bt)
      .map(function (w) {
        var I = w[0];
        if (I === "p" || I === "P") {
...
function $e(r, t) {
  ...
  if (o.date) {
    var i = ir(o.date, a);
    n = fr(i.restDateString, i.year);
  }
  if (!n || isNaN(n.getTime())) return new Date(NaN);
  var d = n.getTime(),
    s = 0,
    l;
  if (o.time && ((s = sr(o.time)), isNaN(s))) return new Date(NaN);
  if (o.timezone) {
    if (((l = ur(o.timezone)), isNaN(l))) return new Date(NaN);
  } else {
    var c = new Date(d + s),
      p = new Date(0);
    return (
...
function fr(r, t) {
  ...
  var a = !!e[4],
    ...
    d = Q(e[4]),
    s = Q(e[5]) - 1;
  if (a) return pr(t, d, s) ? dr(t, d, s) : new Date(NaN);
  var l = new Date(0);
  return !mr(t, n, i) || !cr(t, o) ? new Date(NaN) : (l.setUTCFullYear(t, n, Math.max(o, i)), l);
}
function Q(r) {
...
function sr(r) {
  ...
  var e = ce(t[1]),
    a = ce(t[2]),
    o = ce(t[3]);
  return vr(e, a, o) ? e * me + a * le + o * 1e3 : NaN;
}
function ce(r) {
...
function mr(r, t, e) {
  return t >= 0 && t <= 11 && e >= 1 && e <= (lr[t] || (Qe(r) ? 29 : 28));
}
function cr(r, t) {
  return t >= 1 && t <= (Qe(r) ? 366 : 365);
}
function pr(r, t, e) {
...
function De(r, t) {
  ...
  if (n < 1) i = 0;
    ...
    var d = _(e, a) === -o;
    (ye(u(r)) && n === 1 && _(r, a) === 1 && (d = !1), (i = o * (n - Number(d))));
  }
  return i === 0 ? 0 : i;
}
function Te(r, t, e) {
...
function Ge(r, t) {
  ...
  var d = [],
    s = o;
  s.setHours(0, 0, 0, 0);
  var l = Number((e = t?.step) !== null && e !== void 0 ? e : 1);
  if (l < 1 || isNaN(l)) throw new RangeError("`options.step` must be a number greater than 1");
  for (; s.getTime() <= i; ) (d.push(u(s)), s.setDate(s.getDate() + l), s.setHours(0, 0, 0, 0));
  return d;
}
function ze(r, t) {
  var e;
  ...
  for (; l.getTime() <= d; ) (s.push(u(l)), (l = ve(l, c)));
  return s;
}
function X(r, t) {
  if (r == null)
...
function Me(r, t, e) {
  ...
  var s = X(Oe(e), { addSuffix: !!e?.addSuffix, comparison: d }),
    l,
    c;
  d > 0 ? ((l = u(t)), (c = u(r))) : ((l = u(r)), (c = u(t)));
  var p = Te(c, l),
    x = (q(c) - q(l)) / 1e3,
    v = Math.round((p - x) / 60),
    h;
  ...
  if (v < je) {
    ...
    if (v < wr) return i.formatDistance("xDays", 1, s);
    if (v < be) {
      var y = Math.round(v / je);
      return i.formatDistance("xDays", y, s);
    } else if (v < yr) return ((h = Math.round(v / be)), i.formatDistance("aboutXMonths", h, s));
  }
  if (((h = De(c, l)), h < 12)) {
...
function Je(r, t) {
  ...
  if (i !== "time") {
    var p = m(o.getDate(), 2),
      x = m(o.getMonth() + 1, 2),
      v = m(o.getFullYear(), 4);
    d = "".concat(v).concat(l).concat(x).concat(l).concat(p);
  }
  if (i !== "date") {
    var h = o.getTimezoneOffset();
    if (h !== 0) {
      var D = Math.abs(h),
        y = m(Math.floor(D / 60), 2),
        O = m(D % 60, 2),
        S = h < 0 ? "+" : "-";
      s = "".concat(S).concat(y, ":").concat(O);
    } else s = "Z";
    var b = m(o.getHours(), 2),
      F = m(o.getMinutes(), 2),
      Z = m(o.getSeconds(), 2),
      W = d === "" ? "" : "T",
      Y = [b, F, Z].join(c);
...
export { A as a, Se as b, Ge as c, ze as d, Re as e, Ve as f, Je as g, Ze as h, $e as i };
//# sourceMappingURL=chunk-DXEB74DT.mjs.map
