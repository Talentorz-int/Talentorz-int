import { d as M, f as Pe } from "chunk-5N7HA7LK.mjs";
import { dd as w } from "chunk-KIWT3OS5.mjs";
import { a as h, b as g } from "chunk-OTG7ZBX3.mjs";
import {
  B as ne,
  Mg as $e,
  Sa as ie,
...
import { o as ge } from "chunk-RJAQ7ZXH.mjs";
import { a as ye, b as P, e as L, f as G, j as Re } from "chunk-DYNCKUFC.mjs";
import { X as B } from "chunk-3GX5YKYT.mjs";
import { a as k, b as D } from "chunk-6PNPO5DW.mjs";
var A = "--";
function Tt(e) {
  return !e.includes(A);
}
...
function Rt(e) {
  return !G(e) || e.type !== "object"
    ? !1
    : e.value === null
      ? !0
      : Object.values(e.value).every(yt);
}
function Jr(e) {
  return Re(e) && e.every((t) => Ie(t) && Rt(t));
}
function de(e, t) {
...
function dn(e, t) {
  return O(_e(de(e, t), t), t);
}
function gt(e, t) {
  let r = g(e);
  return t.nodes.document.create(void 0, Ct(r.children, t));
}
function Ct(e, t) {
  return e.flatMap((r) => {
    try {
...
function bt(e) {
  return e.nodes.textBlock.create(ee());
}
function kt(e, t) {
  switch (e.type) {
    case "textBlock":
      return t.nodes.textBlock.create(
        {
          ...ee(),
          tag: e.tag,
          textDirection: e.textDirection === "inherit" ? "auto" : e.textDirection,
        },
        e.children.map((r) => Dt(r, t))
      );
    case "bulletedList": {
      let r = e.children.flatMap((n) => {
        let i = n.children.flatMap((o) => V(o, t));
        return i.length === 0 ? [] : [t.nodes.listItem.create(te(), i)];
      });
      if (r.length === 0)
        throw new Error("Bulleted list does not contain any supported list item content.");
      return t.nodes.bulletedList.create(
        { ...Me(), textDirection: e.textDirection === "inherit" ? "auto" : e.textDirection },
        r
      );
    }
    case "numberedList": {
      ...
      return t.nodes.numberedList.create(
        {
          ...ve(),
          textDirection: e.textDirection === "inherit" ? "auto" : e.textDirection,
    ...
    case "blockquote": {
      if (!ce(t)) throw new Error("Schema does not support blockquotes.");
      let r = e.children.flatMap((n) => V(n, t));
      if (r.length === 0)
        throw new Error("Blockquote does not contain any supported child content.");
      return t.nodes.blockquote.create(void 0, r);
    }
    case "media":
      if (!ae(t)) throw new Error("Schema does not support media.");
      return t.nodes.image.create({
        src: e.src,
        alt: e.alt,
        ...
        type: e.mediaType,
        link: e.link?.link,
        openInNewTab: e.link?.openInNewTab,
    ...
    case "module":
      if (!le(t)) throw new Error("Schema does not support modules.");
      return t.nodes.module.create({
        identifier: e.identifier,
        props: e.props,
        width: e.width ? Ae(e.width) : void 0,
        alignment: e.alignment ? Fe(e.alignment) : void 0,
      });
    case "table":
      if (!se(t)) throw new Error("Schema does not support tables.");
      return t.nodes.table.create(
        void 0,
        e.children.map((r) =>
          t.nodes.table_row.create(
            void 0,
            r.children.map((n) =>
              t.nodes[n.cellType === "header" ? "table_header" : "table_cell"].create(
                void 0,
                (() => {
                  let i = n.children.flatMap((o) => V(o, t));
                  return i.length === 0 ? [bt(t)] : i;
                })()
              )
            )
          )
...
function Dt(e, t) {
  return e.type === "lineBreak" ? t.nodes.lineBreak.create() : t.text(e.text, Bt(e, t));
}
function Bt(e, t) {
  let r = [];
  if (
...
var Nt = "data-framer-link",
  Lt = "data-framer-open-in-new-tab",
  It = "data-framer-smooth-scroll",
  Vt = "data-framer-click-tracking-id",
  St = "data-framer-rel",
  Et = "data-framer-preserve-params",
  Pt = "framer-module",
  Mt = "data-module-identifier",
  vt = "data-module-props",
  Ot = "data-module-width",
  wt = "data-module-alignment",
  At = /\s+/u;
function Ze(e, t) {
  let r = Pe(e),
    n = { type: "richText", variant: t, children: z(r) };
  return g(n);
}
function Ft(e) {
  let t = [];
...
function zt(e) {
  ...
  switch (e.tagName) {
    ...
    case "img":
      return Ue(t, "image");
    case "video":
      return pe(t, "framer-image") ? Ue(t, "video") : void 0;
    case Pt:
    case "template":
      return jt(t);
    case "table":
    ...
    case "figure": {
      ...
      let n = N(e).find((i) => i.tagName === "table");
...
function Wt(e, t, r) {
  return { id: h(), type: "bulletedList", textDirection: fe(t, r), children: et(e) };
}
function _t(e, t, r) {
  let n = tr(t.get("start")) ?? 1,
    i = Zt(e, r);
  return {
    id: h(),
    type: "numberedList",
...
function et(e) {
  return N(e)
    ...
    .map((t) => ({ id: h(), type: "listItem", children: z(t) }));
}
function $t(e) {
  return { id: h(), type: "blockquote", children: z(e) };
}
function Ue(e, t) {
  ...
  if (t === "image") {
    let i = e.get("alt");
    i !== void 0 && (r.alt = i);
    let o = Ye(e.get("data-framer-width"));
    o !== void 0 && (r.pixelWidth = o);
    let a = Ye(e.get("data-framer-height"));
...
function Ht(e) {
  ...
  for (let r of N(e)) {
    ...
    if (!(r.tagName !== "tbody" && r.tagName !== "thead" && r.tagName !== "tfoot"))
      for (let n of N(r)) n.tagName === "tr" && t.push(n);
  }
  return t;
}
function Gt(e) {
  let t = [];
  for (let r of N(e)) (r.tagName !== "td" && r.tagName !== "th") || t.push(Ut(r));
...
function tt(e, t, r) {
  for (let n of e) {
    ...
    if (!me(n)) continue;
    if (n.tagName === "br") {
      if (pe(q(n), "trailing-break")) continue;
      r.push(Yt());
      continue;
    }
    let i = Qt(n, t);
...
function rt(e) {
  ...
  if (r === void 0) return;
  let n = Qe(e.get(St)) ?? Qe(e.get("rel")) ?? [],
    i = { link: r, openInNewTab: Xe(e.get(Lt)), smoothScroll: Xe(e.get(It)), relValues: n },
    o = e.get(Vt);
...
function Zt(e, t) {
  ...
  if (n) return n;
  let i = N(e).find((o) => o.tagName === "li");
  return (i && nt(q(i).get("style")).get("list-style-type")) || "decimal";
}
function Je(e) {
  switch (e) {
    case "auto":
...
function nr(e) {
  return !rr(e) || typeof e.type != "string"
    ? !1
    : e.type === "url"
      ? typeof e.url == "string"
      : e.type === "webPage"
...
function W(e, t) {
  switch (e.type) {
    case "textBlock":
      t.textBlock?.(e);
      for (let r of e.children) ar(r, t);
      return;
    case "bulletedList":
      t.bulletedList?.(e);
      for (let r of e.children) ot(r, t);
      return;
    case "numberedList":
      t.numberedList?.(e);
      for (let r of e.children) ot(r, t);
    ...
    case "table":
      t.table?.(e);
      for (let r of e.children) ir(r, t);
      return;
  }
}
function ot(e, t) {
...
function ir(e, t) {
  t.tableRow?.(e);
  for (let r of e.children) or(r, t);
}
function or(e, t) {
  t.tableCell?.(e);
  for (let r of e.children) W(r, t);
...
function Sn(e) {
  return typeof e == "string"
    ? Q(e)
    : b(e)
      ? Le(g(e), { preserveTrailingEmptyBlockNewLine: !0 })
      : "";
}
function En(e) {
  return typeof e == "string" ? Q(e).length === 0 : b(e) ? !hr(g(e)) : !0;
}
function hr(e) {
  return (
    ct(e, {
...
function st(e, t, r) {
  ...
  ((t.cache.parentDirected = e.layout),
    ...
    be(e.stackDirection) && r
      ? (t.cache.parentDirection = e.resolveValue("stackDirection") ?? ke)
      : (t.cache.parentDirection = e.stackDirection ?? null),
    Ne(e) && ((t.cache.parentWidthType = e.widthType), (t.cache.parentHeightType = e.heightType)));
}
function An(e, t) {
  st(e, t, !1);
}
  ...
  if (J(e))
    return e.type === void 0
      ? P(e.value)
        ...
        : { ...e, type: void 0, value: X(e, { preserveNewLines: !0 }) }
      : { ...e, type: void 0, value: X(e, { preserveNewLines: !0 }) };
}
function xr(e, t) {
  if (J(e)) {
    if (yr(e.value)) return { ...e, type: "rich-text", value: e.value };
    if (e.type === "rich-text" && P(e.value)) return { ...e, type: "rich-text", value: e.value };
    if (P(e.value)) return { ...e, type: "rich-text", value: w(t, e.value) };
  }
}
function Gn(e, t, r) {
  switch (e) {
...
function yr(e) {
  return b(e) && Se(e.variant);
}
var Te = "[a-z1-9]+(?:-[a-z1-9]+)*",
  Rr = `${Te}="[^"]*"`,
  gr = String.raw`(?:\s+${Rr})*`,
  Cr = String.raw`<${Te}${gr}\s*>`,
  br = `(?:${Cr})+`,
  kr = String.raw`<\/\s*${Te}\s*>`,
  Dr = `(?:${kr})+`,
  Br = "[^<>]*",
  ut = String.raw`\s*`,
  Nr = new RegExp(`^${ut}${br}${Br}${Dr}${ut}$`, "iu");
function Qn(e) {
    ...
    if (re(u)) {
      ...
      for (let s of u.marks)
        ((f ||= ne(s)),
          (y ||= oe(s)),
          Oe(s) && (m ??= s.attrs),
          ie(s) && o.push(s.attrs.linkStylePreset),
          Ee(s) && (x = s.attrs.inlineStyles));
  ...
  p.doc.descendants((u, f, y) => {
    ...
    if (re(u)) {
      let x = !1,
        m = !1,
        s = y ? R.get(y) : void 0;
      for (let E of u.marks)
        if (((x ||= ne(E)), (m ||= oe(E)), ie(E))) {
          let ht = o.length > 1 ? o.shift() : o[0];
          d.addMark(f, f + u.nodeSize, r.marks.link.create({ ...E.attrs, linkStylePreset: ht }));
        }
...
function j(e, t, r) {
  return (
    k(t === "boolean", "Unsupported enum output type:", t),
    ye(e) || I(e) ? r(e) : { type: "LiteralValue", value: Y(t, void 0) }
  );
}
function Vr(e, t, r, n) {
  function i(o) {
  ...
  switch ((k(U(e.name), `Transform is not a valid expression: ${e.name}`), e.name)) {
    case "contains":
      switch (r?.type) {
        case "multicollectionreference":
          return { type: "BinaryOperation", operator: "in", left: i(e.value), right: t };
        default:
          return { type: "FunctionCall", functionName: "CONTAINS", arguments: [t, i(e.value)] };
      }
    case "containsAny": {
      let o = i(e.value),
        a = {
    ...
    case "convertFromEnum": {
      if (r?.type !== "enum") return { type: "LiteralValue", value: Y(e.outputType, void 0) };
      let o = new Set(),
        a = [];
...
function Er(e, t, r, n, i, o) {
  ...
  for (let { itemKey: d, transforms: R } of a) {
    ...
    let f = [],
      ...
      m = H(d, u, r, n, o, x);
    for (let s of R) K(s.name) && (m = Vr(s, m, u, y));
...
function Pr(e, t) {
  if (e.length !== 0)
    return e.reduce(
      (r, n) => {
        let i = vr(n.expression, n.optionalVariables, t);
...
function Mr(e, t) {
  ...
  let r = e.reduce(
    (o, a) => {
      let l = Or(a.expression, a.optionalVariables, t);
  ...
  return (
    k(i.length > 0, "allUsedOptionalVariables should have at least one element"),
    wr(r, i, t)
  );
}
function vr(e, t, r) {
...
function Ar(e, t, r, n, i, o) {
  ...
  if (e.collectionFilters && e.collectionFilters.filters.length === 1) {
    ...
    if ((k(a, "filter should exist"), a.itemKey)) {
      let l = t.get(a.itemKey),
        c = H(a.itemKey, l, r, n, o),
        p = Fr(e, a.transforms, c, l, i);
      if (p) return [p];
    }
  }
...
function Fr(e, t, r, n, i) {
  ...
  let o = t[0];
  if ((k(o, "Transform must exist"), o.name === "isIncludedIn" && I(o.value)))
    return {
      type: "FunctionCall",
...
function Vi(e, t, r, n, i) {
  let o = {},
    a = new Set(),
    l = Ir(e);
  e.collectionFilters && (o.where = Er(e, t, a, l, n, i));
  let c = t.get(e.getPrimaryId());
  k(c, "Control map of repeater must exist");
  let p = Ar(e, c, a, l, n, i);
  ...
  let d = qr(c, r, a, l, i);
  return { from: zr(e.dataIdentifier, c, a, l, i), select: d, ...o };
}
function H(e, t, r, n, i, o = !0) {
  (o && t?.type === "collectionreference" && !we(e) && (e += ".id"), r.add(e));
  let [a, l] = mt(e, n);
...
//# sourceMappingURL=chunk-E4V4QQI3.mjs.map
