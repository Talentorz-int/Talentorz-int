import { B as U, h as w, i as M } from "chunk-E4V4QQI3.mjs";
import { Tc as k } from "chunk-KIWT3OS5.mjs";
import { g as C } from "chunk-QNKC3NEE.mjs";
import { Eq as V, Fi as P, Gk as T, al as S, dc as d, dl as D } from "chunk-C45BQYIA.mjs";
import { xa as N } from "chunk-HSCVLSVX.mjs";
import { b as s, l, o as c, r as L, u as z } from "chunk-DYNCKUFC.mjs";
import { Ba as R, k as x, sa as v } from "chunk-3GX5YKYT.mjs";
import { a as f } from "chunk-6PNPO5DW.mjs";
import { j as y } from "chunk-XELMBOBL.mjs";
var g = new Map([
...
function q(a) {
  if (typeof a == "string") {
    let t = R(a);
    return t ? (v(t) ? g.get(t.moduleId) : void 0) : g.get(a);
  }
  if (v(a)) return g.get(a.moduleId);
}
function H(a, t) {
  let i = typeof t == "string" ? R(t) : t;
  if (!i || !v(i)) return !1;
  let n = a.getNode(i.moduleId);
  return n ? n.namespaceId === "b1dc0e2c-9212-4d15-aaf0-73b747e96996" : !1;
}
function W(a) {
  return (s(a) && P.has(a)) || q(a) !== void 0;
}
function _(a, t) {
  return H(a, t) || W(t);
}
...
var F = class {
  constructor(t) {
    this.environment = t;
    y(this, "dataByRenderId", new Map());
    y(this, "itemIdsByRenderId", new Map());
    y(this, "updatedDataByNodeId", new Map());
    y(this, "updatedItemIdsByRenderId", new Map());
  }
  set(t, i, n) {
    if (
      (f(this.environment === "sandbox", "Setting data is only allowed in the sandbox."),
      (i ??= x()),
      this.dataByRenderId.get(t) === i)
    )
      return;
    if ((this.dataByRenderId.set(t, i), M(t))) {
      let u = A(i, n);
      this.updatedDataByNodeId.set(t, u);
    }
    let r = i.map(J),
      o = this.itemIdsByRenderId.get(t);
    N(r, o) || (this.itemIdsByRenderId.set(t, r), this.updatedItemIdsByRenderId.set(t, r));
  }
  import(t) {
    f(this.environment === "editor", "Importing data is only allowed in the editor.");
    let { dataUpdates: i, itemIdsUpdates: n } = t,
      e = new Set();
    for (let { nodeId: r, data: o } of i) (this.dataByRenderId.set(r, o), e.add(r));
    for (let { renderId: r, itemIds: o } of n) (this.itemIdsByRenderId.set(r, o), e.add(r));
    return e;
  }
  isEmpty(t) {
    let i = this.dataByRenderId.get(t);
    return !i || i.length === 0;
  }
  getData(t) {
  ...
  export() {
    if (
      ...
      return;
    let t = [];
    for (let [n, e] of this.updatedDataByNodeId) t.push({ nodeId: n, data: e });
    this.updatedDataByNodeId.clear();
    let i = [];
    for (let [n, e] of this.updatedItemIdsByRenderId) i.push({ renderId: n, itemIds: e });
    return (this.updatedItemIdsByRenderId.clear(), { dataUpdates: t, itemIdsUpdates: i });
  }
};
function A(a, t) {
  return a.map((i) => {
...
var G = /^<(\w+)[^>]*><br class="trailing-break"><\/\1>$/u;
function B(a) {
  return typeof a == "string" ? a === "" || G.test(a) : w(a);
}
function me(a) {
  let t = new Map();
  for (let i of a) i.type !== "divider" && t.set(i.id, i);
  return t;
}
function E(a, t, i, n, e, r) {
  if (t.type !== "string" || s(i?.value)) return;
  let o = n.get(a);
...
function ye(a, t, i, n, e) {
  let r = e.getControlProp(a),
    u = E(a, t, r, i, n, e) ?? V(t, r);
  if (U(u)) return u;
}
function O({ control: a, controlProp: t, resolvers: i, locale: n }) {
  switch (t.type) {
    case "array": {
      ...
      if (d(e)) return;
      let r = e.map(
        (o) => O({ control: a.control, controlProp: o, resolvers: i, locale: n }) ?? null
      );
      return { type: "array", value: r };
    }
    case "boolean": {
      let { value: e } = t;
      return d(e) || c(e) ? void 0 : { type: "boolean", value: e };
    }
    ...
    case "color": {
      let { value: e } = t;
      if (d(e) || c(e)) return;
      let r = i.resolveColor(e);
      return l(r) ? void 0 : { type: "color", value: r };
    }
    case "date": {
      ...
      let r = new Date(e);
      return z(r)
        ? (a.displayTime || r.setUTCHours(0, 0, 0, 0), { type: "date", value: r.toISOString() })
        : void 0;
    }
    case "enum": {
      let { value: e } = t;
    ...
    case "file": {
      let { value: e } = t;
      if (d(e) || l(e)) return;
      let r = i.resolveFile(e);
      return l(r) ? void 0 : { type: "file", value: r };
    }
    case "image": {
      let e = I(a, t.valueLocalized, n),
        r = e?.value,
        o = s(r) ? r : t.value;
      if (d(o) || l(o)) return;
      let u = e?.imageFocalPoint ?? t,
        p = i.resolveImage(o, u);
      if (l(p)) return;
      let m = I(a, t.altLocalized, n),
        b = s(m?.value) ? m.value : t.alt;
      return { type: "responsiveimage", value: { ...p, alt: b } };
    }
    case "link": {
      let e = D(t.value);
      if (S(e)) {
        let o = I(a, t.valueLocalized, n);
        s(o?.value) && o.value && (e = D(o.value));
      }
      if (d(e) || l(e)) return;
      let r = i.resolveLink(e);
      return l(r) ? void 0 : { type: "link", value: r };
    }
    ...
    case "number": {
      let { value: e } = t;
      return d(e) || c(e) ? void 0 : { type: "number", value: e };
    }
    case "object": {
      f(a.type === "object", "Invalid control");
      let { value: e } = t;
      if (d(e) || c(e)) return;
      let r = k(a.controls, (o, u) => {
        let p = e[o];
        return p ? (O({ control: u, controlProp: p, resolvers: i, locale: n }) ?? null) : null;
      });
      return (T(t) && (r[C] = { type: "string", value: t.id }), { type: "object", value: r });
    }
    case "richtext": {
      let r = I(a, t.valueLocalized, n)?.value ?? t.value;
      if (d(r) || B(r)) return;
      let o = i.resolveRichTextPointer(r);
      return l(o) ? void 0 : { type: "richtext", value: o };
    }
    case "string": {
      let e = I(a, t.valueLocalized, n),
        r = s(e?.value) ? e.value : t.value;
      return d(r) || c(r) ? void 0 : { type: "string", value: r };
    }
    case "vectorsetitem": {
      let { value: e } = t;
      if (d(e) || l(e)) return;
      let r = i.resolveVectorSetItemPointer(e);
      return l(r) ? void 0 : { type: "vectorsetitem", value: r };
    }
    default:
  }
}
...
function Y(a, t = (i) => i) {
  switch (a.type) {
    case "array": {
      let i = Y(a.control, t);
      return (
        (i.definitions[C] = { type: t("string"), isNullable: !1 }),
        { type: t("array"), isNullable: !0, definition: i }
      );
    }
    case "boolean":
    case "color":
    ...
    case "object": {
      let i = Object.entries(a.controls),
        n = {};
      for (let [e, r] of i) {
        let o = Y(r, t);
        o && (n[e] = o);
      }
      return { type: t("object"), isNullable: !0, definitions: n };
    }
    case "vectorsetitem":
...
export { B as a, W as b, _ as c, J as d, F as e, me as f, ye as g, O as h, Y as i };
//# sourceMappingURL=chunk-IY77CULL.mjs.map
