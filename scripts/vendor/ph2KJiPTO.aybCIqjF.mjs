...
import { C as l } from "./motion.C4Ab7j_2.mjs";
import { A as u, C as d, Y as f, _ as ee, o as p, r as te, t as ne } from "./framer.A_mnCMV8.mjs";
function m(e) {
...
var w,
  ...
  nt = e(() => {
    (t(),
      ...
      (Ge = (e, t, n) => (
        (n = e == null ? {} : T(k(e))),
        We(!t && e && e.__esModule ? n : E(n, `default`, { value: e, enumerable: !0 }), e)
      )),
      (N = (e, t, n) => j(e, typeof t == `symbol` ? t : t + ``, n)),
      (Ke = Ge(
        M({
...
function rt(e) {
  return typeof e == `object` && !!e && !i(e) && ot in e;
}
function it(e, ...t) {
  if (!e) throw Error(`Assertion Error` + (t.length > 0 ? `: ` + t.join(` `) : ``));
}
...
var K,
  ...
  Wt = e(() => {
    (f(),
      ...
      ct(),
      (q = {
        bDnJt7ezd: { isNullable: !0, type: p.String },
        Cb7tH425r: { isNullable: !0, type: p.String },
        CqJEutvNA: { isNullable: !0, type: p.String },
        createdAt: { isNullable: !0, type: p.Date },
        D4QNKxGBc: { isNullable: !0, type: p.String },
        e6jeDMKuE: { isNullable: !0, type: p.VectorSetItem },
        fbmFuhfrq: { isNullable: !0, type: p.String },
        G_KGjL3rk: { isNullable: !0, type: p.VectorSetItem },
        Gwn0NbArS: { isNullable: !0, type: p.String },
        id: { isNullable: !1, type: p.String },
        jsSaaSxPq: { isNullable: !0, type: p.String },
        K9eTUxfPi: { isNullable: !0, type: p.String },
        KxxlisKuv: { isNullable: !0, type: p.String },
        nextItemId: { isNullable: !0, type: p.String },
        NXhX3GDYD: { isNullable: !0, type: p.VectorSetItem },
        O7PqGHbEq: { isNullable: !0, type: p.String },
        oqRw_bwfb: { isNullable: !0, type: p.String },
        pOVO21QE9: { isNullable: !0, type: p.ResponsiveImage },
        previousItemId: { isNullable: !0, type: p.String },
        qY7iKNwEW: { isNullable: !0, type: p.Number },
        RqeAZI7H9: { isNullable: !0, type: p.VectorSetItem },
        Sigc8edc9: { isNullable: !0, type: p.ResponsiveImage },
        T7aARsTWe: { isNullable: !0, type: p.RichText },
        trgu1quJN: { isNullable: !0, type: p.String },
        updatedAt: { isNullable: !0, type: p.Date },
        w07L4llti: { isNullable: !0, type: p.String },
        y4Jz_grvy: { isNullable: !0, type: p.String },
        yuVNX0DsD: { isNullable: !0, type: p.RichText },
        yztvFF5hR: { isNullable: !0, type: p.String },
        ZW71AtKcQ: { isNullable: !0, type: p.String },
      }),
      (lt = [`id`]),
      (J = { type: 1 }),
      (ut = [`previousItemId`]),
      ...
      (Lt = [`yuVNX0DsD`]),
      (Rt = [
        () => import(`./IKTVpX5qn.DDUU_ZHq.mjs`),
        () => import(`./CbnKwqN2_.CEJ3eNMH.mjs`),
        () => import(`./vg1v3uWYO.CU246EZx.mjs`),
        () => import(`./D5cs2H7UB.CTki-o6I.mjs`),
        () => import(`./gQx5dPd3m.Bs3PNWSp.mjs`),
        () => import(`./hiO95K8aS.7xRoklzo.mjs`),
        () => import(`./to6hH0i12.BxkWYPYN.mjs`),
        () => import(`./ToUBkEhni.Bzkdypwr.mjs`),
        () => import(`./TWMSVpnV8.CFsu_Qhc.mjs`),
        () => import(`./hqKc9RA03.BqUP5gHE.mjs`),
        () => import(`./X4i3dzXvZ.DoYhOCPs.mjs`),
        () => import(`./unur7AShG.D99Krjnp.mjs`),
        () => import(`./DmN3Dolou.D_Dol-_m.mjs`),
        () => import(`./ehzuGRE0y.BFUECHch.mjs`),
        () => import(`./bMH4fgQ3u.CpETVcqI.mjs`),
        () => import(`./vSWuACCeu.Bdpabqyc.mjs`),
      ]),
      (zt = (e) => {
        let t = Rt[e];
      ...
      (Q = {
        collectionByLocaleId: {
          default: new tt({
            chunks: [
              new URL(
                `./ph2KJiPTO-chunk-default-0.framercms`,
                `https://framerusercontent.com/modules/nRFTRRBFQyYR30tmyjkm/b2rJ7p45Em1Qo7NNBber/ph2KJiPTO.js`
              ).href.replace(`/modules/`, `/cms/`),
            ],
            id: `c681fe4a-1beb-487b-9a7b-f685afc052c6default`,
            indexes: [
              new W({
                collation: J,
                collectionSchema: q,
                ...
                range: { from: 0, to: 145 },
                url: new URL(
                  `./ph2KJiPTO-indexes-default-0.framercms`,
                  `https://framerusercontent.com/modules/nRFTRRBFQyYR30tmyjkm/b2rJ7p45Em1Qo7NNBber/ph2KJiPTO.js`
                ).href.replace(`/modules/`, `/cms/`),
              }),
              new W({
        ...
        id: `c681fe4a-1beb-487b-9a7b-f685afc052c6`,
      }),
      (Vt = Q),
      u(Q, {
        CqJEutvNA: { defaultValue: ``, title: `Service Title`, type: p.String },
        qY7iKNwEW: { defaultValue: 0, title: `Count`, type: p.Number },
        O7PqGHbEq: { preventLocalization: !1, title: `Slug`, type: p.String },
        oqRw_bwfb: { defaultValue: ``, title: `Highlight`, type: p.String },
        Sigc8edc9: { title: `Main Image`, type: p.ResponsiveImage },
        T7aARsTWe: { defaultValue: ``, title: `Overview`, type: p.RichText },
        pOVO21QE9: { title: `Image 1`, type: p.ResponsiveImage },
        KxxlisKuv: { defaultValue: ``, title: `Title (What we do)`, type: p.String },
        fbmFuhfrq: { defaultValue: ``, title: `Description (what we do)`, type: p.String },
        Cb7tH425r: { defaultValue: ``, title: `Title (Services Offered)`, type: p.String },
        y4Jz_grvy: { defaultValue: ``, title: `Description (Service Offered)`, type: p.String },
        RqeAZI7H9: {
          defaultValue: {
        ...
        D4QNKxGBc: { defaultValue: ``, title: `Title Value 1`, type: p.String },
        yztvFF5hR: { defaultValue: ``, title: `Description Value 1`, type: p.String },
        NXhX3GDYD: {
          defaultValue: {
            identifier: `module:BLjRczXRCa2XMZlRX1af/3JLV0naPYn0LHwD9pOLX/ljGcHeWyh.js:default`,
            moduleId: `BLjRczXRCa2XMZlRX1af`,
        ...
        Gwn0NbArS: { defaultValue: ``, title: `Title Value 2`, type: p.String },
        trgu1quJN: { defaultValue: ``, title: `Description Value 2`, type: p.String },
        G_KGjL3rk: {
          defaultValue: {
            identifier: `module:BLjRczXRCa2XMZlRX1af/3JLV0naPYn0LHwD9pOLX/ljGcHeWyh.js:default`,
            moduleId: `BLjRczXRCa2XMZlRX1af`,
        ...
        K9eTUxfPi: { defaultValue: ``, title: `Title Value 3`, type: p.String },
        w07L4llti: { defaultValue: ``, title: `Description Value 3`, type: p.String },
        e6jeDMKuE: {
          defaultValue: {
            identifier: `module:BLjRczXRCa2XMZlRX1af/3JLV0naPYn0LHwD9pOLX/ljGcHeWyh.js:default`,
            moduleId: `BLjRczXRCa2XMZlRX1af`,
        ...
        ZW71AtKcQ: { defaultValue: ``, title: `Title Value 4`, type: p.String },
        bDnJt7ezd: { defaultValue: ``, title: `Description Value 4`, type: p.String },
        jsSaaSxPq: { defaultValue: ``, title: `Title (How We Do It)`, type: p.String },
        yuVNX0DsD: { defaultValue: ``, title: `Description (How We Do It)`, type: p.RichText },
        createdAt: { title: `Created`, type: p.Date },
        updatedAt: { title: `Updated`, type: p.Date },
        previousItemId: {
          dataIdentifier: `local-module:collection/ph2KJiPTO:default`,
          title: `Previous`,
          ...
          let [n] = await Z.query(
            {
              ...
              select: [{ name: `O7PqGHbEq`, type: `Identifier` }],
              where: {
          ...
          let [n] = await Z.query(
            {
              ...
              where: {
                left: { name: `O7PqGHbEq`, type: `Identifier` },
                operator: `==`,
                right: { type: `LiteralValue`, value: e },
                type: `BinaryOperation`,
              },
        ...
        exports: {
          default: {
            ...
            annotations: {
              ...
              framerData: `true`,
              framerSlug: `O7PqGHbEq`,
              framerCollectionUtils: `1`,
              framerRecordIdKey: `id`,
              framerCollectionId: `ph2KJiPTO`,
...
export { Ut as a, Vt as i, Ht as n, Wt as r, $ as t };
//# sourceMappingURL=ph2KJiPTO.aybCIqjF.mjs.map
