import { b as s } from "chunk-DYNCKUFC.mjs";
var B = null,
  S = "i-invalid",
...
function T(t) {
  return t ? (t.startsWith("id_") && (t = t.slice(3)), t.replace(/\\/gu, "")) : "";
}
function m(t) {
  return t;
}
var d = m;
typeof window < "u" && window.CSS && (d = window.CSS.escape);
function W(t) {
  return d("id_" + t);
}
var y = ((e) => (
...
function w(t) {
  return t.split(" ").map(h).join(" ");
}
function H(t) {
  let i = t.match(x);
  if (!i) return t;
  let [, u, r, D] = i;
  return r ? u + r.toUpperCase() + D : t;
}
export {
  y as a,
  C as b,
...
//# sourceMappingURL=chunk-A4TNDN6S.mjs.map
