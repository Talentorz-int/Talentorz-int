import { a as T } from "chunk-EQBCTBZ3.mjs";
import { b as v, h as I, l as L, o as O } from "chunk-DYNCKUFC.mjs";
import { a as R } from "chunk-UZNETSBG.mjs";
import { a as _ } from "chunk-SJONTHBI.mjs";
import { Qa as m, Z as S } from "chunk-3GX5YKYT.mjs";
import { a as b } from "chunk-6PNPO5DW.mjs";
import { e as J, j as c, k as E, l as A, m as P } from "chunk-XELMBOBL.mjs";
var $ = {
...
function Q(n) {
  ...
  for (let t in n) {
    let a = n[t];
    if (typeof a == "object") ((e[t] = a.value), (j[t] = a.variants));
...
var x = Q({
    ...
    passkeys: "off",
    patching: D(["collections"], "off"),
    preventVariableDeletion: "on",
    previewSharing: "off",
    prioritizedModuleEvaluation: "on",
    protectedStaging: "on",
    prototypeTreeDriver: D(["dynamicOverrides"], "dynamicOverrides"),
  ...
  X = ["agent", "branching", "modulesInTree", "jsonRichTextStorage"];
function Y(n) {
  return X.includes(n);
}
var U = {
  ...
  C = { vantara: [{ sample: 0.5, scope: "User", includeEnterprise: !1, variant: "on" }] };
var Z = {
...
var p = !1,
  ...
  F = class {
    ...
    get(e) {
      this.assertOnUse &&
        b(p, "Tried to read state of", e, "before update, await on .updated first");
    ...
    is(e, t) {
      ...
      return L(a) ? this.activeConfig[e] === t : a;
    }
    isOn(e) {
      return (
        this.assertOnUse &&
          b(p, "Tried to read the state of", e, "before update, await on .updated first"),
        this.is(e, "on")
      );
    }
    getVariantName(e) {
    ...
    update(e) {
      ...
      for (let t in e) {
        let a = k(e[t]);
        if (!v(a) || a === this.activeConfig[t]) continue;
        this.activeConfig[t] = a;
        let o = this.listeners.get(t);
        o && o.forEach((r) => r(a, t));
      }
      E(this, f) && (E(this, f).call(this), P(this, f, void 0));
    }
...
function B(n) {
  return function ({ children: t, ...a }) {
    ...
    return y(n, r, o) ? s.default.createElement(s.default.Fragment, null, t) : null;
  };
}
function ae(n, e) {
  p = !0;
...
function we(n) {
  ((i.isEnterprise.Project = n.license.type === "enterpriseSite"), (i.hashes.Project = m(n.id)));
}
function M(n) {
  ((i.isEnterprise.User = n.spaces.some((e) => e.license?.type === "enterprise")),
    (i.hashes.User = m(n.id)));
}
function Ce(n, e) {
  ((i.isEnterprise.Team = e === "enterprise"), (i.hashes.Team = m(n)));
}
function Ne(n) {
  i.channel = n;
}
function re(n, { sample: e, scope: t, variant: a, includeEnterprise: o, channels: r }) {
  if (r)
    if (i.channel) {
  ...
  let d = e * oe,
    l = m(n),
    g = m(a);
  return O(i.hashes[t]) || O(i.isEnterprise[t]) || (!o && i.isEnterprise[t])
    ? !1
    : (i.hashes[t] ^ l ^ g) >>> 0 < d;
}
function z(n = C) {
...
var ke = B(u);
function Be(n, e) {
  return y(u, n, (a) => a === "on") || W(n, e);
}
function Me(n, e) {
  return y(u, n, (t) => t === e);
}
function ze(n, e) {
  return u.isOn(n) || W(n, e);
}
function W(n, e) {
  return !e || !N[e] ? !1 : N[e].includes(n);
}
function V() {
  if (typeof window > "u") return "experiments";
  let n = T(window)?.channel;
...
function G() {
  ...
  let { channel: t, override: a } = e,
    o = a === "tunnel" && S.isDevelopment;
  return (
    (t === "alpha" || t === "local" || o) && Object.assign(n, U, w),
    t === "beta" && Object.assign(n, U),
    n
  );
}
function se() {
  let n = {};
  try {
    let e = JSON.parse(localStorage[V()] || "{}");
    Object.assign(n, e);
  } catch {}
  return n;
}
...
function ce(n) {
  return "experiments" in n && v(n.experiments);
}
function fe() {
  let n = {};
  if (typeof window > "u") return {};
...
function We({ resetStorage: n, resetSession: e } = {}) {
  if (!(typeof window > "u")) {
    if ((n && localStorage.removeItem(V()), e)) {
...
function Ge(n) {
  ...
  let a = { ...t, ...n };
  for (let o of R(a)) u.getInitial(o) === a[o] && delete a[o];
  try {
...
//# sourceMappingURL=chunk-RJAQ7ZXH.mjs.map
