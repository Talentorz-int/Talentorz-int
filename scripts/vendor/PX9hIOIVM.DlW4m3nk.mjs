...
import { C as p, a as m, r as ne, t as re } from "./motion.C4Ab7j_2.mjs";
import {
  A as h,
  Ct as g,
  N as _,
  ...
  return s((t, n) => {
    ...
    return r && !i
      ...
      : o(e, {
          ...
          title: `Votre site professionnel réalisé avec Framer.`,
    ...
    c(u, {
      children: [
        o(`p`, {
          ...
          children: `Votre site professionnel réalisé avec Framer.`,
        }),
        o(e, { ...t, ref: n }),
      ],
    })
...
e(() => {
  (l(),
    ...
    (Y = ie(C(g(p.a, { nodeId: `HK2sXlagE`, override: de, scopeId: `PX9hIOIVM` })))),
    (X = `framer-6jWyo`),
    ...
    (Se = ({ value: e, children: n }) => {
      ...
      return o(m.Provider, { value: a, children: n });
    }),
    (Z = p.create(i)),
    ...
    (Q = v(
      s(function (e, t) {
        let n = r(null),
          i = t ?? n,
          a = te(),
          { activeLocale: s, setLocale: ee } = oe();
        ce();
        let { style: l, className: u, layoutId: d, variant: f, ...m } = Ce(e),
          {
            ...
            setVariant: se,
            variants: x,
          } = le({ defaultVariant: `HK2sXlagE`, ref: i, variant: f, variantClassNames: ge }),
          S = we(e, x),
          C = _(X);
        return o(ne, {
          id: d ?? a,
...
//# sourceMappingURL=PX9hIOIVM.DlW4m3nk.mjs.map
