import { e as f, j as A, m as T, n as v } from "chunk-43FBLJGU.mjs";
import { eh as h, gi as u } from "chunk-KIWT3OS5.mjs";
import { ia as C } from "chunk-3GX5YKYT.mjs";
import { a as d } from "chunk-6PNPO5DW.mjs";
...
function F(s, e, t, o) {
  let r = s.getPartialDocumentForPageIds(t),
    ...
    p = h(r, null, { extraChecksAndFixes: !0, errors: i, warnings: c });
  (f("parsingRootNode"), d(p, "error loading root node:", r.id, i));
  for (let g of p.children ?? []) g.children && g.children.length > 0 && T(g, i);
  (i.length > 0 &&
    l.warn(
...
function P(s, e) {
  ...
  if (!t) return !0;
  let o = [],
    r = h(t, s.root.id, { extraChecksAndFixes: !0, errors: o });
  return (
    d(r, "error loading page node:", t.id, o),
    T(r, o),
    o.length > 0 &&
      l.warn(
        "warnings loading server tree: " +
...
var m = class s {
    constructor() {
      ...
      n(this, "isViewOnly", !1);
      n(this, "inEditor", !1);
      n(this, "processingLocalUserEdits", !1);
    }
    static from(e) {
      let t = new s();
      return (
  ...
  b = class {
    constructor(e, t, o) {
      ...
      n(this, "pagesToAssemble");
      n(this, "isSetupNeeded", !0);
      n(this, "engineTreeFlags", new m());
...
export { F as a, P as b, S as c, m as d, b as e };
//# sourceMappingURL=chunk-C4RI6J7Q.mjs.map
