...
d.prototype = {
  constructor: d,
  find: function (s) {
    for (var t = 0; t < this.content.length; t += 2) if (this.content[t] === s) return t;
    return -1;
  },
  get: function (s) {
    var t = this.find(s);
  ...
  update: function (s, t, e) {
    var n = e && e != s ? this.remove(e) : this,
      i = n.find(s),
      r = n.content.slice();
  ...
  forEach: function (s) {
    for (var t = 0; t < this.content.length; t += 2) s(this.content[t], this.content[t + 1]);
  },
  prepend: function (s) {
  ...
  subtract: function (s) {
    var t = this;
    s = d.from(s);
    for (var e = 0; e < s.content.length; e += 2) t = t.remove(s.content[e]);
    return t;
  },
  toObject: function () {
    var s = {};
...
function it(s, t, e) {
  for (let n = 0; ; n++) {
    if (n == s.childCount || n == t.childCount) return s.childCount == t.childCount ? null : e;
    let i = s.child(n),
      r = t.child(n);
    if (i == r) {
      e += i.nodeSize;
    ...
    if (!i.sameMarkup(r)) return e;
    if (i.isText && i.text != r.text) {
      for (let l = 0; i.text[l] == r.text[l]; l++) e++;
      return e;
    }
    if (i.content.size || r.content.size) {
      let l = it(i.content, r.content, e + 1);
      if (l != null) return l;
    }
    e += i.nodeSize;
  }
...
function rt(s, t, e, n) {
  for (let i = s.childCount, r = t.childCount; ; ) {
    if (i == 0 || r == 0) return i == r ? null : { a: e, b: n };
    let l = s.child(--i),
      o = t.child(--r),
      h = l.nodeSize;
    if (l == o) {
...
var p = class s {
  ...
  textBetween(t, e, n, i) {
    ...
    return (
      this.nodesBetween(
        ...
        (o, h) => {
          let a = o.isText
            ? o.text.slice(Math.max(t, h) - h, e - h)
            : o.isLeaf
              ? i
                ? typeof i == "function"
                  ? i(o)
                ...
                : o.type.spec.leafText
                  ...
                  : ""
              : "";
          (o.isBlock && ((o.isLeaf && a) || o.isTextblock) && n && (l ? (l = !1) : (r += n)),
            (r += a));
        },
        0
      ),
  ...
  append(t) {
    ...
    let e = this.lastChild,
      ...
      r = 0;
    for (
      e.isText && e.sameMarkup(n) && ((i[i.length - 1] = e.withText(e.text + n.text)), (r = 1));
      r < t.content.length;
      r++
    )
      i.push(t.content[r]);
    return new s(i, this.size + t.size);
  }
  cut(t, e = this.size) {
    ...
    if (e > t)
      for (let r = 0, l = 0; l < e; r++) {
        ...
        (h > t &&
          ((l < t || h > e) &&
            (o.isText
              ? (o = o.cut(Math.max(0, t - l), Math.min(o.text.length, e - l)))
              : (o = o.cut(Math.max(0, t - l - 1), Math.min(o.content.size, e - l - 1)))),
          n.push(o),
          (i += o.nodeSize)),
          (l = h));
      }
  ...
  replaceChild(t, e) {
    ...
    return ((i[t] = e), new s(i, r));
  }
  addToStart(t) {
    return new s([t].concat(this.content), this.size + t.nodeSize);
  }
  addToEnd(t) {
    return new s(this.content.concat(t), this.size + t.nodeSize);
  }
  eq(t) {
  ...
  findIndex(t) {
    if (t == 0) return T(0, t);
    if (t == this.size) return T(this.content.length, t);
    if (t > this.size || t < 0) throw new RangeError(`Position ${t} outside of fragment (${this})`);
    for (let e = 0, n = 0; ; e++) {
      let i = this.child(e),
        r = n + i.nodeSize;
      if (r >= t) return r == t ? T(e + 1, r) : T(e, n);
      n = r;
    }
  }
  toString() {
  ...
  static fromJSON(t, e) {
    ...
    return new s(e.map(t.nodeFromJSON));
  }
  static fromArray(t) {
    if (!t.length) return s.empty;
    let e,
      n = 0;
    for (let i = 0; i < t.length; i++) {
      let r = t[i];
      ((n += r.nodeSize),
        i && r.isText && t[i - 1].sameMarkup(r)
          ? (e || (e = t.slice(0, i)),
            (e[e.length - 1] = r.withText(e[e.length - 1].text + r.text)))
          : e && e.push(r));
    }
    return new s(e || t, n);
  }
  static from(t) {
    ...
    if (t.attrs) return new s([t], t.nodeSize);
...
function T(s, t) {
  return ((F.index = s), (F.offset = t), F);
}
function M(s, t) {
  if (s === t) return !0;
  if (!(s && typeof s == "object") || !(t && typeof t == "object")) return !1;
  let e = Array.isArray(s);
  if (Array.isArray(t) != e) return !1;
  if (e) {
    if (s.length != t.length) return !1;
    for (let n = 0; n < s.length; n++) if (!M(s[n], t[n])) return !1;
  } else {
    for (let n in s) if (!(n in t) || !M(s[n], t[n])) return !1;
    for (let n in t) if (!(n in s)) return !1;
  }
  return !0;
}
var c = class s {
  ...
  addToSet(t) {
    ...
    for (let i = 0; i < t.length; i++) {
      ...
      if (this.type.excludes(r.type)) e || (e = t.slice(0, i));
      else {
        if (r.type.excludes(this.type)) return t;
        (!n && r.type.rank > this.type.rank && (e || (e = t.slice(0, i)), e.push(this), (n = !0)),
          e && e.push(r));
      }
    }
  ...
  static setFrom(t) {
    if (!t || (Array.isArray(t) && t.length == 0)) return s.none;
    if (t instanceof s) return [t];
    let e = t.slice();
...
var C = class extends Error {},
  w = class s {
    ...
    insertAt(t, e) {
      let n = lt(this.content, t + this.openStart, e);
      return n && new s(n, this.openStart, this.openEnd);
    }
    removeBetween(t, e) {
      return new s(
        st(this.content, t + this.openStart, e + this.openStart),
        this.openStart,
        this.openEnd
      );
    }
    ...
    static fromJSON(t, e) {
      ...
      return new s(p.fromJSON(t, e.content), n, i);
    }
...
w.empty = new w(p.empty, 0, 0);
function st(s, t, e) {
  let { index: n, offset: i } = s.findIndex(t),
    r = s.maybeChild(n),
    { index: l, offset: o } = s.findIndex(e);
  if (i == t || r.isText) {
    if (o != e && !s.child(l).isText) throw new RangeError("Removing non-flat range");
    return s.cut(0, t).append(s.cut(e));
  }
  if (n != l) throw new RangeError("Removing non-flat range");
  return s.replaceChild(n, r.copy(st(r.content, t - i - 1, e - i - 1)));
}
function lt(s, t, e, n) {
  let { index: i, offset: r } = s.findIndex(t),
    l = s.maybeChild(i);
  if (r == t || l.isText)
    return n && !n.canReplace(i, i, e) ? null : s.cut(0, t).append(e).append(s.cut(t));
  let o = lt(l.content, t - r - 1, e, l);
  return o && s.replaceChild(i, l.copy(o));
}
function kt(s, t, e) {
  if (e.openStart > s.depth) throw new C("Inserted content deeper than insertion position");
  if (s.depth - e.openStart != t.depth - e.openEnd) throw new C("Inconsistent open depths");
  return ot(s, t, e, 0);
}
function ot(s, t, e, n) {
  let i = s.index(n),
  ...
  if (i == t.index(n) && n < s.depth - e.openStart) {
    ...
    if (!e.openStart && !e.openEnd && s.depth == n && t.depth == n) {
      let l = s.parent,
        o = l.content;
      return m(l, o.cut(0, s.parentOffset).append(e.content).append(o.cut(t.parentOffset)));
    } else {
      let { start: l, end: o } = St(e, s);
      return m(r, at(s, l, o, t, n));
    }
  else return m(r, z(s, t, n));
}
function ht(s, t) {
  if (!t.type.compatibleContent(s.type))
    throw new C("Cannot join " + t.type.name + " onto " + s.type.name);
}
function B(s, t, e) {
  let n = s.node(e);
  return (ht(n, t.node(e)), n);
}
function x(s, t) {
  let e = t.length - 1;
...
function E(s, t, e, n) {
  let i = (t || s).node(e),
    r = 0,
    l = t ? t.index(e) : i.childCount;
  s && ((r = s.index(e)), s.depth > e ? r++ : s.textOffset && (x(s.nodeAfter, n), r++));
  for (let o = r; o < l; o++) x(i.child(o), n);
  t && t.depth == e && t.textOffset && x(t.nodeBefore, n);
}
function m(s, t) {
  return (s.type.checkContent(t), s.copy(t));
}
function at(s, t, e, n, i) {
  let r = s.depth > i && B(s, t, i + 1),
    l = n.depth > i && B(e, n, i + 1),
    o = [];
  return (
    E(null, s, i, o),
    r && l && t.index(i) == e.index(i)
      ? (ht(r, l), x(m(r, at(s, t, e, n, i + 1)), o))
      : (r && x(m(r, z(s, t, i + 1)), o), E(t, e, i, o), l && x(m(l, z(e, n, i + 1)), o)),
    E(n, null, i, o),
    new p(o)
  );
}
function z(s, t, e) {
  let n = [];
  if ((E(null, s, e, n), s.depth > e)) {
    let i = B(s, t, e + 1);
    x(m(i, z(s, t, e + 1)), n);
  }
  return (E(t, null, e, n), new p(n));
}
function St(s, t) {
  let e = t.depth - s.openStart,
    i = t.node(e).copy(s.content);
  for (let r = e - 1; r >= 0; r--) i = t.node(r).copy(p.from(i));
  return {
...
var A = class s {
    ...
    posAtIndex(t, e) {
      ...
      let n = this.path[e * 3],
        i = e == 0 ? 0 : this.path[e * 3 - 1] + 1;
      for (let r = 0; r < t; r++) i += n.child(r).nodeSize;
      return i;
    }
    marks() {
      let t = this.parent,
      ...
      for (var l = 0; l < r.length; l++)
        r[l].type.spec.inclusive === !1 &&
          (!i || !r[l].isInSet(i.marks)) &&
          (r = r[l--].removeFromSet(r));
      return r;
    }
    marksAcross(t) {
      ...
      for (var r = 0; r < n.length; r++)
        n[r].type.spec.inclusive === !1 &&
          (!i || !n[r].isInSet(i.marks)) &&
          (n = n[r--].removeFromSet(n));
      return n;
    }
    sharedDepth(t) {
    ...
    blockRange(t = this, e) {
      ...
      for (
        ...
        if (t.pos <= this.end(n) && (!e || e(this.node(n)))) return new J(this, t, n);
      return null;
    }
    sameParent(t) {
    ...
    static resolve(t, e) {
      ...
      let n = [],
        ...
        r = e;
      for (let l = t; ; ) {
        let { index: o, offset: h } = l.content.findIndex(r),
          a = r - h;
        if ((n.push(l, o, i + h), !a || ((l = l.child(o)), l.isText))) break;
        ((r = a - 1), (i += h + 1));
      }
      return new s(e, n, r);
    }
    static resolveCached(t, e) {
      ...
      else G.set(t, (n = new P()));
      let i = (n.elts[n.i] = s.resolve(t, e));
      return ((n.i = (n.i + 1) % Et), i);
    }
  },
  P = class {
    constructor() {
  ...
  y = class s {
    constructor(t, e, n, i = c.none) {
      ((this.type = t), (this.attrs = e), (this.marks = i), (this.content = n || p.empty));
    }
    get children() {
    ...
    hasMarkup(t, e, n) {
      return (
        this.type == t &&
        M(this.attrs, e || t.defaultAttrs || Ot) &&
        c.sameSet(this.marks, n || c.none)
      );
    }
    copy(t = null) {
      return t == this.content ? this : new s(this.type, this.attrs, t, this.marks);
    }
    mark(t) {
      return t == this.marks ? this : new s(this.type, this.attrs, this.content, t);
    }
    ...
    slice(t, e = this.content.size, n = !1) {
      if (t == e) return w.empty;
      let i = this.resolve(t),
        r = this.resolve(e),
        l = n ? 0 : i.sharedDepth(e),
        o = i.start(l),
        a = i.node(l).content.cut(i.pos - o, r.pos - o);
      return new w(a, i.depth - l, r.depth - l);
    }
    replace(t, e, n) {
      return kt(this.resolve(t), this.resolve(e), n);
    }
    nodeAt(t) {
      for (let e = this; ; ) {
    ...
    resolve(t) {
      return A.resolveCached(this, t);
    }
    resolveNoCache(t) {
      return A.resolve(this, t);
    }
    rangeHasMark(t, e, n) {
      let i = !1;
    ...
    canReplace(t, e, n = p.empty, i = 0, r = n.childCount) {
      let l = this.contentMatchAt(t).matchFragment(n, i, r),
        o = l && l.matchFragment(this.content, e);
      if (!o || !o.validEnd) return !1;
      for (let h = i; h < r; h++) if (!this.type.allowsMarks(n.child(h).marks)) return !1;
      return !0;
    }
    canReplaceWith(t, e, n, i) {
      if (i && !this.type.allowsMarks(i)) return !1;
      let r = this.contentMatchAt(t).matchType(n),
        l = r && r.matchFragment(this.content, e);
    ...
    static fromJSON(t, e) {
      ...
      let i = p.fromJSON(t, e.content),
        r = t.nodeType(e.type).create(e.attrs, i, n);
      return (r.type.checkAttrs(r.attrs), r);
    }
  };
y.prototype.text = void 0;
var q = class s extends y {
  constructor(t, e, n, i) {
    if ((super(t, e, null, i), !n)) throw new RangeError("Empty text nodes are not allowed");
    this.text = n;
  }
  toString() {
    return this.type.spec.toDebugString
      ? this.type.spec.toDebugString(this)
      : ft(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
  ...
  mark(t) {
    return t == this.marks ? this : new s(this.type, this.attrs, this.text, t);
  }
  withText(t) {
    return t == this.text ? this : new s(this.type, this.attrs, t, this.marks);
  }
...
function ft(s, t) {
  for (let e = s.length - 1; e >= 0; e--) t = s[e].type.name + "(" + t + ")";
  return t;
}
var k = class s {
  constructor(t) {
  ...
  matchFragment(t, e = 0, n = t.childCount) {
    let i = this;
    for (let r = e; i && r < n; r++) i = i.matchType(t.child(r).type);
    return i;
  }
  get inlineContent() {
  ...
  compatible(t) {
    for (let e = 0; e < this.next.length; e++)
      for (let n = 0; n < t.next.length; n++) if (this.next[e].type == t.next[n].type) return !0;
    return !1;
  }
  fillBefore(t, e = !1, n = 0) {
    ...
    function r(l, o) {
      ...
      if (h && (!e || h.validEnd)) return p.from(o.map((a) => a.createAndFill()));
      for (let a = 0; a < l.next.length; a++) {
        let { type: f, next: u } = l.next[a];
        if (!(f.isText || f.hasRequiredAttrs()) && i.indexOf(u) == -1) {
          i.push(u);
          let g = r(u, o.concat(f));
          if (g) return g;
        }
      }
      return null;
  ...
  computeWrapping(t) {
    ...
    for (; n.length; ) {
      ...
      if (r.matchType(t)) {
        let l = [];
        for (let o = i; o.type; o = o.via) l.push(o.type);
        return l.reverse();
      }
      for (let l = 0; l < r.next.length; l++) {
        ...
        !o.isLeaf &&
          ...
          !(o.name in e) &&
          (!i.type || h.validEnd) &&
          (n.push({ match: o.contentMatch, type: o, via: i }), (e[o.name] = !0));
      }
    }
    return null;
  }
  ...
  toString() {
    ...
    function e(n) {
      t.push(n);
      for (let i = 0; i < n.next.length; i++) t.indexOf(n.next[i].next) == -1 && e(n.next[i].next);
    }
    return (
      e(this),
      t.map((n, i) => {
...
function bt(s) {
  let t = Mt(s);
  for (;;)
    if (s.eat("+")) t = { type: "plus", expr: t };
    else if (s.eat("*")) t = { type: "star", expr: t };
    else if (s.eat("?")) t = { type: "opt", expr: t };
    else if (s.eat("{")) t = Tt(s, t);
    else break;
  return t;
}
function H(s) {
...
function Mt(s) {
  ...
  } else if (/\W/.test(s.next)) s.err("Unexpected token '" + s.next + "'");
  else {
    let t = vt(s, s.next).map(
      (e) => (
        s.inline == null
          ? (s.inline = e.isInline)
          : s.inline != e.isInline && s.err("Mixing inline and block content"),
        { type: "name", value: e }
      )
    );
...
function zt(s) {
  ...
  function r(l, o) {
    if (l.type == "choice") return l.exprs.reduce((h, a) => h.concat(r(a, o)), []);
    if (l.type == "seq")
      for (let h = 0; ; h++) {
        let a = r(l.exprs[h], o);
      ...
      if (l.type == "opt") return [n(o)].concat(r(l.expr, o));
      if (l.type == "range") {
        let h = o;
...
function Q(s, t) {
  let e = [];
  return (n(t), e.sort(ut));
  function n(i) {
    let r = s[i];
    if (r.length == 1 && !r[0].term) return n(r[0].to);
    e.push(i);
  ...
  function e(n) {
    ...
    n.forEach((l) => {
      s[l].forEach(({ term: o, to: h }) => {
        if (!o) return;
        let a;
        for (let f = 0; f < i.length; f++) i[f][0] == o && (a = i[f][1]);
        Q(s, h).forEach((f) => {
...
function Nt(s, t) {
  for (let e = 0, n = [s]; e < n.length; e++) {
    ...
    for (let o = 0; o < i.next.length; o++) {
      ...
      (l.push(h.name),
        r && !(h.isText || h.hasRequiredAttrs()) && (r = !1),
...
function gt(s, t, e, n) {
  for (let i in t)
    if (!(i in s)) throw new RangeError(`Unsupported attribute ${i} for ${e} of type ${i}`);
  for (let i in s) {
    let r = s[i];
...
function yt(s, t) {
  let e = Object.create(null);
  if (t) for (let n in t) e[n] = new W(s, n, t[n]);
  return e;
}
var N = class s {
  constructor(t, e, n) {
    ((this.name = t),
      ...
      (this.attrs = yt(t, n.attrs)),
      (this.defaultAttrs = pt(this.attrs)),
  ...
  computeAttrs(t) {
    return !t && this.defaultAttrs ? this.defaultAttrs : dt(this.attrs, t);
  }
  create(t = null, e, n) {
    if (this.isText) throw new Error("NodeType.create can't construct text nodes");
    return new y(this, this.computeAttrs(t), p.from(e), c.setFrom(n));
  }
  createChecked(t = null, e, n) {
    return (
      (e = p.from(e)),
      this.checkContent(e),
      new y(this, this.computeAttrs(t), e, c.setFrom(n))
    );
  }
  createAndFill(t = null, e, n) {
    if (((t = this.computeAttrs(t)), (e = p.from(e)), e.size)) {
      let l = this.contentMatch.fillBefore(e);
      if (!l) return null;
      e = l.append(e);
    }
    let i = this.contentMatch.matchFragment(e),
      r = i && i.fillBefore(p.empty, !0);
    return r ? new y(this, t, e.append(r), c.setFrom(n)) : null;
  }
  validContent(t) {
    let e = this.contentMatch.matchFragment(t);
    if (!e || !e.validEnd) return !1;
    for (let n = 0; n < t.childCount; n++) if (!this.allowsMarks(t.child(n).marks)) return !1;
    return !0;
  }
  checkContent(t) {
  ...
  checkAttrs(t) {
    gt(this.attrs, t, "node", this.name);
  }
  allowsMarkType(t) {
...
var W = class {
    constructor(t, e, n) {
      ((this.hasDefault = Object.prototype.hasOwnProperty.call(n, "default")),
        ...
        (this.validate = typeof n.validate == "string" ? Rt(t, e, n.validate) : n.validate));
    }
    get isRequired() {
  ...
  j = class s {
    constructor(t, e, n, i) {
      ((this.name = t),
        ...
        (this.schema = n),
        (this.spec = i),
        (this.attrs = yt(t, i.attrs)),
        (this.excluded = null));
      let r = pt(this.attrs);
      this.instance = r ? new c(this, r) : null;
    }
    create(t = null) {
      return !t && this.instance ? this.instance : new c(this, dt(this.attrs, t));
    }
    static compile(t, e) {
      let n = Object.create(null),
        i = 0;
      return (t.forEach((r, l) => (n[r] = new s(r, i++, e, l))), n);
    }
    removeFromSet(t) {
    ...
    checkAttrs(t) {
      gt(this.attrs, t, "mark", this.name);
    }
    excludes(t) {
  ...
  X = class {
    constructor(t) {
      ...
      ((e.nodes = I.from(t.nodes)),
        ...
        (this.nodes = N.compile(this.spec.nodes, this)),
      ...
      for (let i in this.nodes) {
        ...
        let r = this.nodes[i],
          ...
          o = r.spec.marks;
        if (
          ((r.contentMatch = n[l] || (n[l] = k.parse(l, this.nodes))),
          (r.inlineContent = r.contentMatch.inlineContent),
          r.spec.linebreakReplacement)
        ) {
        ...
        r.markSet =
          o == "_" ? null : o ? Y(this, o.split(" ")) : o == "" || !r.inlineContent ? [] : null;
      }
      for (let i in this.marks) {
        let r = this.marks[i],
          l = r.spec.excludes;
        r.excluded = l == null ? [r] : l == "" ? [] : Y(this, l.split(" "));
      }
      ((this.nodeFromJSON = (i) => y.fromJSON(this, i)),
    ...
    text(t, e) {
      ...
      return new q(n, n.defaultAttrs, t, c.setFrom(e));
    }
    mark(t, e) {
...
function Y(s, t) {
  ...
  for (let n = 0; n < t.length; n++) {
    ...
    if (!l) throw new SyntaxError("Unknown mark type: '" + t[n] + "'");
  }
  return e;
}
function It(s) {
...
var Z = class s {
    ...
    parse(t, e = {}) {
      let n = new R(this, e, !1);
      return (n.addAll(t, c.none, e.from, e.to), n.finish());
    }
    parseSlice(t, e = {}) {
      let n = new R(this, e, !0);
      return (n.addAll(t, c.none, e.from, e.to), w.maxOpen(n.finish()));
    }
    matchTag(t, e, n) {
      for (let i = n ? this.tags.indexOf(n) + 1 : 0; i < this.tags.length; i++) {
        ...
        if (
          Pt(t, r.tag) &&
          (r.namespace === void 0 || t.namespaceURI == r.namespace) &&
          (!r.context || e.matchesContext(r.context))
        ) {
          if (r.getAttrs) {
            let l = r.getAttrs(t);
            if (l === !1) continue;
    ...
    static schemaRules(t) {
      let e = [];
      function n(i) {
        let r = i.priority == null ? 50 : i.priority,
          l = 0;
        for (; l < e.length; l++) {
          let o = e[l];
          if ((o.priority == null ? 50 : o.priority) < r) break;
        }
        e.splice(l, 0, i);
      }
      for (let i in t.marks) {
        ...
        r &&
          r.forEach((l) => {
            (n((l = _(l))), l.mark || l.ignore || l.clearMark || (l.mark = i));
          });
      }
      for (let i in t.nodes) {
        ...
        r &&
          r.forEach((l) => {
            (n((l = _(l))), l.node || l.ignore || l.mark || (l.node = i));
          });
      }
      return e;
    }
    static fromSchema(t) {
      return t.cached.domParser || (t.cached.domParser = new s(t, s.schemaRules(t)));
    }
  },
  xt = {
    address: !0,
...
var S = class {
    constructor(t, e, n, i, r, l) {
      ((this.type = t),
        ...
        (this.match = r || (l & O ? null : t.contentMatch)));
    }
    findWrapping(t) {
      if (!this.match) {
        if (!this.type) return [];
        let e = this.type.contentMatch.fillBefore(p.from(t));
        ...
        if (n && n.isText && (i = /[ \t\r\n\u000c]+$/.exec(n.text))) {
          ...
          n.text.length == i[0].length
            ...
            : (this.content[this.content.length - 1] = r.withText(
                r.text.slice(0, r.text.length - i[0].length)
              ));
        }
      }
      let e = p.from(this.content);
      return (
        !t && this.match && (e = e.append(this.match.fillBefore(p.empty, !0))),
    ...
    inlineContext(t) {
      return this.type
        ...
        : this.content.length
          ...
          : t.parentNode && !xt.hasOwnProperty(t.parentNode.nodeName.toLowerCase());
    }
  },
  R = class {
    constructor(t, e, n) {
      ...
      let i = e.topNode,
        r,
        l = K(null, e.preserveWhitespace, 0) | (n ? O : 0);
      (i
        ? (r = new S(i.type, i.attrs, c.none, !0, e.topMatch || i.type.contentMatch, l))
        : n
          ? (r = new S(null, null, c.none, !0, null, l))
          : (r = new S(t.schema.topNodeType, null, c.none, !0, null, l)),
        (this.nodes = [r]),
    ...
    addTextNode(t, e) {
      let n = t.nodeValue,
        i = this.top,
        r = i.options & U ? "full" : this.localPreserveWS || (i.options & b) > 0;
...
`
    ...
    addElement(t, e, n) {
      ...
      let l = t.nodeName.toLowerCase(),
        o;
      mt.hasOwnProperty(l) && this.parser.normalizeLists && Bt(t);
      let h =
        (this.options.ruleFromNode && this.options.ruleFromNode(t)) ||
        (o = this.parser.matchTag(t, this, n));
      t: if (h ? h.ignore : Dt.hasOwnProperty(l)) (this.findInside(t), this.ignoreFallback(t, e));
      else if (!h || h.skip || h.closeParent) {
        h && h.closeParent
          ? (this.open = Math.max(0, this.open - 1))
          : h && h.skip.nodeType && (t = h.skip);
        let a,
          f = this.needsBlock;
        if (xt.hasOwnProperty(l))
          (r.content.length && r.content[0].isInline && this.open && (this.open--, (r = this.top)),
            (a = !0),
        ...
        let u = h && h.skip ? e : this.readStyles(t, e);
        (u && this.addAll(t, u), a && this.sync(r), (this.needsBlock = f));
      } else {
...
`),
    ...
    readStyles(t, e) {
      ...
      if (n && n.length)
        for (let i = 0; i < this.parser.matchedStyles.length; i++) {
          let r = this.parser.matchedStyles[i],
            l = n.getPropertyValue(r);
          if (l)
            for (let o = void 0; ; ) {
              ...
              if (
                (h.clearMark
                  ? (e = e.filter((a) => !h.clearMark(a)))
                  : (e = e.concat(this.parser.schema.marks[h.mark].create(h.attrs))),
                h.consuming === !1)
              )
                o = h;
              else break;
    ...
    addElementByRule(t, e, n, i) {
      ...
      let o = this.top;
      if (l && l.isLeaf) this.findInside(t);
      else if (i) this.addElement(t, n, i);
      else if (e.getContent)
        (this.findInside(t),
          e.getContent(t, this.parser.schema).forEach((h) => this.insertNode(h, n, !1)));
      else {
        let h = t;
        (typeof e.contentElement == "string"
          ? (h = t.querySelector(e.contentElement))
          : typeof e.contentElement == "function"
            ? (h = e.contentElement(t))
            : e.contentElement && (h = e.contentElement),
          this.findAround(t, h, !0),
          this.addAll(h, n),
          this.findAround(t, h, !1));
      }
    ...
    addAll(t, e, n, i) {
      let r = n || 0;
      for (
        let l = n ? t.childNodes[n] : t.firstChild, o = i == null ? null : t.childNodes[i];
        l != o;
        l = l.nextSibling, ++r
      )
    ...
    findPlace(t, e, n) {
      ...
      for (let l = this.open, o = 0; l >= 0; l--) {
        let h = this.nodes[l],
          a = h.findWrapping(t);
        if (a && (!i || i.length > a.length + o) && ((i = a), (r = h), !a.length)) break;
        if (h.solid) {
          if (n) break;
          o += 2;
        }
      ...
      if (!i) return null;
      this.sync(r);
      for (let l = 0; l < i.length; l++) e = this.enterInner(i[l], null, e, !1);
      return e;
    }
    insertNode(t, e, n) {
      ...
      if (i) {
        ...
        for (let o of i.concat(t.marks))
          (r.type ? r.type.allowsMarkType(o.type) : $(o.type, t.type)) && (l = o.addToSet(l));
    ...
    enterInner(t, e, n, i = !1, r) {
      ...
      let o = K(t, r, l.options);
      l.options & O && l.content.length == 0 && (o |= O);
      let h = c.none;
      return (
        (n = n.filter((a) =>
          (l.type ? l.type.allowsMarkType(a.type) : $(a.type, t)) ? ((h = a.addToSet(h)), !1) : !0
        )),
        this.nodes.push(new S(t, e, h, i, null, o)),
        this.open++,
        n
      );
    }
    ...
    get currentPos() {
      ...
      for (let e = this.open; e >= 0; e--) {
        ...
        for (let i = n.length - 1; i >= 0; i--) t += n[i].nodeSize;
        e && t++;
      }
      return t;
    }
      ...
      if (t != e && this.find)
        for (let i = 0; i < this.find.length; i++)
          this.find[i].pos == null &&
            ...
            e.compareDocumentPosition(this.find[i].node) & (n ? 2 : 4) &&
    ...
    matchesContext(t) {
      ...
      let e = t.split("/"),
        ...
        r = -(n ? n.depth + 1 : 0) + (i ? 0 : 1),
        l = (o, h) => {
          for (; o >= 0; o--) {
            let a = e[o];
            if (a == "") {
              if (o == e.length - 1 || o == 0) continue;
              for (; h >= r; h--) if (l(o - 1, h)) return !0;
              return !1;
            } else {
              let f =
                h > 0 || (h == 0 && i)
                  ...
                  : n && h >= r
                    ? n.node(h - r).type
                    : null;
              if (!f || (f.name != a && !f.isInGroup(a))) return !1;
              h--;
            }
          }
          return !0;
...
function Pt(s, t) {
  return (s.matches || s.msMatchesSelector || s.webkitMatchesSelector || s.mozMatchesSelector).call(
    s,
    t
  );
}
...
function $(s, t) {
  ...
  for (let n in e) {
    let i = e[n];
    if (!i.allowsMarkType(s)) continue;
    let r = [],
      l = (o) => {
        r.push(o);
        for (let h = 0; h < o.edgeCount; h++) {
          let { type: a, next: f } = o.edge(h);
          if (a == t || (r.indexOf(f) < 0 && l(f))) return !0;
        }
      };
...
var tt = class s {
  ...
  serializeFragment(t, e = {}, n) {
    n || (n = D(e).createDocumentFragment());
    let i = n,
      r = [];
    return (
      t.forEach((l) => {
        if (r.length || l.marks.length) {
          ...
          for (; o < r.length && h < l.marks.length; ) {
            ...
            if (!a.eq(r[o][0]) || a.type.spec.spanning === !1) break;
            (o++, h++);
          }
          for (; o < r.length; ) i = r.pop()[1];
          for (; h < l.marks.length; ) {
            let a = l.marks[h++],
              f = this.serializeMark(a, l.isInline, e);
  ...
  serializeNodeInner(t, e) {
    let { dom: n, contentDOM: i } = v(D(e), this.nodes[t.type.name](t), null, t.attrs);
    if (i) {
  ...
  serializeMark(t, e, n = {}) {
    ...
    return i && v(D(n), i(t, e), null, t.attrs);
  }
  ...
  static fromSchema(t) {
    return (
      ...
      (t.cached.domSerializer = new s(this.nodesFromSchema(t), this.marksFromSchema(t)))
    );
  }
...
function Jt(s) {
  let t = nt.get(s);
  return (t === void 0 && nt.set(s, (t = qt(s))), t);
}
function qt(s) {
  let t = null;
  function e(n) {
    if (n && typeof n == "object")
      if (Array.isArray(n))
        if (typeof n[0] == "string") (t || (t = []), t.push(n));
        else for (let i = 0; i < n.length; i++) e(n[i]);
      else for (let i in n) e(n[i]);
  }
  return (e(s), t);
}
function v(s, t, e, n) {
  if (typeof t == "string") return { dom: s.createTextNode(t) };
  ...
  let o,
    h = e ? s.createElementNS(e, i) : s.createElement(i),
    a = t[1],
    f = 1;
  if (a && typeof a == "object" && a.nodeType == null && !Array.isArray(a)) {
    ...
    for (let u in a)
      if (a[u] != null) {
        let g = u.indexOf(" ");
        g > 0
          ? h.setAttributeNS(u.slice(0, g), u.slice(g + 1), a[u])
          : u == "style" && h.style
            ? (h.style.cssText = a[u])
            : h.setAttribute(u, a[u]);
      }
  }
  for (let u = f; u < t.length; u++) {
    let g = t[u];
    if (g === 0) {
      if (u < t.length - 1 || u > f)
      ...
      let { dom: wt, contentDOM: V } = v(s, g, e, n);
      if ((h.appendChild(wt), V)) {
...
export { p as a, c as b, C as c, w as d, J as e, y as f, j as g, X as h, Z as i, tt as j };
//# sourceMappingURL=chunk-44TE32RJ.mjs.map
