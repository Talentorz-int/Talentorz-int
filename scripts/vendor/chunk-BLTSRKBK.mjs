import { a as xe } from "chunk-D3SZBJZX.mjs";
import { b as p } from "chunk-SJT3LDOF.mjs";
import { P as X } from "chunk-5JMTOW4C.mjs";
import { if as Ce, rc as P } from "chunk-KIWT3OS5.mjs";
import { f as be } from "chunk-WMNAJO4L.mjs";
import {
  De as ye,
  Nf as A,
  Oc as ge,
...
import { c as Se } from "chunk-2QSZBOLG.mjs";
...
import { e as f, f as v, j as S, k as Z } from "chunk-HSCVLSVX.mjs";
import { a as _ } from "chunk-LEYNIZPU.mjs";
import { o as D } from "chunk-RJAQ7ZXH.mjs";
import { b as J, f as Q, l as K } from "chunk-DYNCKUFC.mjs";
import { X as w, ia as I, oa as y, pa as k } from "chunk-3GX5YKYT.mjs";
import { a as g } from "chunk-6PNPO5DW.mjs";
import { e as j } from "chunk-XELMBOBL.mjs";
var jt = ({ naturalWidth: i, naturalHeight: t }) => ({
...
function M(i) {
  if (!i) return null;
  let t = /(-?[\d.]+)([a-z%]*)/u.exec(i);
  if (!t) return null;
  let [r, o, e] = t;
  if (o === void 0 || e?.startsWith("%")) return null;
  let a = Math.round(parseFloat(o) * ((e && ct[e]) || 1));
  return a <= 0 ? 0 : a;
}
function Xt(i) {
  let t = mt(i);
  if (!t) throw Error("Invalid SVG");
  let r = M(t.getAttribute("width")),
    o = M(t.getAttribute("height"));
  if (r !== null && o !== null) return { width: r, height: o };
  ...
  return { width: r ?? 300, height: o ?? 150 };
}
function mt(i) {
  let t = de(i, "image/svg+xml"),
    r = t.rootElement || t.childNodes[0];
  if (!(!r || r.nodeName.toUpperCase() !== "SVG")) return r;
}
var ut = 5e4,
  pt = 'xlink:href="data:image/',
  Fe = /xlink:href=['"]data:image\/[^;]+;base64,([A-Za-z\d+=/]+)/gu;
function Yt(i) {
  return i.length > ut || i.includes(pt);
}
function Ie(i) {
  let t = 0,
    r;
  for (; (r = Fe.exec(i)); ) {
    let [, o] = r;
    (g(o, "The image regex must have a capture group for the image base64 data"), (t += o.length));
  }
  return (
    (Fe.lastIndex = 0),
    t < 50 * 1024
...
function er(i, t, r, o) {
  let e = { ...t.draftOrCurrent().replicaInfo },
    a = { ...e.overrides };
  ((e.overrides = a), (a[r] = { ...a[r], ...o }), t.set({ replicaInfo: e }, i));
}
function Le(i, t, r) {
  let o = { ...t.draftOrCurrent().replicaInfo },
    e = { ...o.overrides };
  o.overrides = e;
  for (let a in r) e[a] = { ...e[a], ...r[a] };
  t.set({ replicaInfo: o }, i);
}
function Re(i, t, r, o, e) {
  if (R(o)) return;
  let a = pe(t) ? 2 : 0,
    n = b(r.x, a),
    s = b(r.y, a);
  if (
    (O(e.x)
      ? ((e.x = n), (e.y = s))
      : (!k(e.x) && e.x !== n && (e.x = y), !k(e.y) && e.y !== s && (e.y = y)),
    !T(t) || !o)
  )
    return;
  let d = i.getParentSizeInfo(t);
  if (!d?.positioning) return;
  let c = d.positioning,
    m = b(c.width - G.maxX(r), a),
    h = b(c.height - G.maxY(r), a);
  O(e.right)
    ? ((e.right = m), (e.bottom = h))
    : (!k(e.right) && e.right !== m && (e.right = y),
      !k(e.bottom) && e.bottom !== h && (e.bottom = y));
}
var u = {
  padding: 0,
  gridRowCount: 2,
...
var Pe = 10,
  ht = (i = "horizontal", t = !0, r) => {
    let o = r?.stores.persistedUserDefaults.layoutGap ?? Pe;
    return {
      layout: "stack",
      stackDirection: i,
  ...
  ft = (i) => ({
    ...
    gridType: void 0,
    gap: i?.stores.persistedUserDefaults.layoutGap ?? Pe,
    paddingPerSide: !1,
    padding: u.padding,
    paddingTop: u.padding,
    paddingBottom: u.padding,
  ...
  Me = new Set(["#BDF", "#CEF", "#9DF"]),
  wt = "#BDF";
function vt(i) {
  let t = Array.from(Me).filter((r) => r !== i);
  return ((t.length = 2), t);
}
var Ve = (i, t = {}, r = {}) => {
  let { index: o = 0, lastColor: e, parentColor: a, source: n } = r,
    s = wt;
  if (D.isOn("agent")) return Te(i, t, s, n);
  let d = vt(a),
    c = d.length;
  if (((s = d[0] ?? s), o > 0)) s = d[Math.ceil(o / c) % c] ?? s;
  else if (J(e))
    if (Me.has(e)) {
      let m = (d.indexOf(e) + 1) % c;
      s = d[m] ?? s;
    } else s = e;
  return Te(i, t, s, n);
};
function Te(i, t, r, o) {
  o && be("layout_frame", { source: o });
  let e = { fillEnabled: !0, fillColor: r };
  return (
    C(i) &&
      !i.stackWrapEnabled &&
      (i.widthType !== 2 && ((e.width = 1), (e.widthType = 3)),
      i.heightType !== 2 && ((e.height = 1), (e.heightType = 3))),
    Object.assign(e, t),
    new P(e)
  );
}
var Zr = (i, t) => {
    switch (i) {
      case 0:
      case 1: {
        ((t.layout = "stack"), (t.stackDirection = i === 0 ? "vertical" : "horizontal"));
        break;
      }
      case 2:
      case 3:
  ...
  Ae = (i, t, r, o) => {
    let e = new P({ ...ft(i), fillEnabled: !1, ...t });
    g(L(e));
    let a = t.gridType === W,
      n = kt(a, f(t.height) ? t.height : void 0, f(e.gap) ? e.gap : void 0);
    for (let s = 0; s < r; s++) {
      let d = {};
      if (n) {
        let h = s === 0 || s === r - 1 ? n.tallHeight : n.smallHeight;
        Object.assign(d, { heightType: 0, height: h, gridItemFillCellHeight: void 0 });
      } else
        switch (o) {
          case 3:
            ...
            break;
          case 4:
            s + 1 === r && (d.gridItemColumnSpan = 2);
            break;
          default:
            break;
        }
      let c = Ve(e, { ...gt, ...d }, { index: s });
      e.addChild(c);
    }
    return (a && (e.heightType = 2), e);
  },
  _r = (i, t, r, o = !1) => {
    if (t === 2) return Ae(i, r, o ? 0 : 4);
    if (t === 3 || t === 4) return Ae(i, r, o ? 0 : 3, t);
    let e = o ? 0 : 2;
    return yt(i, r, r.stackDirection ?? "horizontal", e, !1);
  },
  Ne = we.width,
  St = (i, t, r, o, e, a) => {
    let n = { x, y: x, right: x, bottom: x };
    (Re(i, t, r, o, n),
      f(n.x) && f(n.right) && e - n.x - n.right < 200 && ((a.left = 0), (a.right = 0)));
  },
  bt = (i, t) => {
    (i.stackDirection === "horizontal" && !i.stackWrapEnabled && (t.stackDirection = "vertical"),
      i.stackWrapEnabled && i.stackDistribution === "start" && (t.stackDistribution = "center"));
  },
  Ct = (i) => {
    let t = {};
    return (
  ...
  xt = (i, t) => {
    f(i.gridColumnCount) && (t.gridColumnCount = 1);
  },
  Ft = (i, t, r, o, e, a) => {
    (St(i, t, r, o, e, a), !(e > Ne) && (C(t) && bt(t, a), L(t) && xt(t, a)));
  },
  It = (i, t, r, o, e, a) => {
    let n = t.getPrimaryId(),
      s = {};
    if ((Ft(i, t, r, o, e, s), (a[n] = s), $(t) && t.stackWrapEnabled && e <= Ne)) {
      let c = Ct(t);
      for (let m in c) a[m] = { ...a[m], ...c[m] };
    }
  };
function qr(i, t, r) {
  let o = i.tree.getNode(t);
  if (!o || !re(o)) return;
  let e = i.tree.getNode(r);
  if (!e || !ce(e) || !F(e)) return;
  let a = i.tree.getScopeNodeFor(e);
  if (!a || !oe(a)) return;
  let n = i.tree.getRect(o),
    s = a.getBreakpointValues();
  for (let d in s) {
    if (d === r) continue;
    let c = i.tree.getNode(d);
    if (!c || !ee(c) || !le(c)) continue;
    let m = {};
    (It(i.tree, o, n, e, c.width, m), Le(i.tree, c, m));
  }
}
function Jr(i, t, r, o = i.getParent(r.id)) {
  let e = {
    width: { 2: !0, 0: !0, 3: !0, 1: !0, 4: !0, 5: !0 },
    height: { 2: !0, 0: !0, 3: !0, 1: !0, 4: !0, 5: !0 },
  };
  if (
    (!o || !T(r) || (Ce(r) && r.autoSize === !0) || fe(r)
      ? ((e.width[1] = !1),
        (e.height[1] = !1),
        (e.width[3] = !1),
        (e.height[3] = !1),
      ...
      : L(o)
        ? A(r, o)
          ? ((e.width[3] = !0),
            (e.height[3] =
              (D.isOn("gridBentoFit") || o.gridRowHeightType !== "fit") && o.gridType !== W))
          : ((e.width[3] = !1), (e.height[3] = !1))
        : C(o)
          ? (A(r, o) || (e.width[3] = !1), A(r, o) || (e.height[3] = !1))
          : ((e.width[3] = !1), (e.height[3] = !1)),
    ke(r) &&
      Q(r.textFitViewBoxSize) &&
      ((e.height[2] = !0),
      (e.width[2] = !1),
      (e.height[0] = !1),
      (e.height[1] = !1),
      (e.height[3] = !1),
      (e.height[4] = !1)),
    (!he(r) || F(r)) && ((e.width[5] = !1), (e.height[5] = !1)),
    se(r))
  ) {
    let n = r.getSupportedLayout(t);
    (N(n.width) || (e.width[2] = !1),
      N(n.height) || (e.height[2] = !1),
      U(n.width) || ((e.width[0] = !1), (e.width[1] = !1), (e.width[3] = !1), (e.width[4] = !1)),
      U(n.height) ||
        ((e.height[0] = !1), (e.height[1] = !1), (e.height[3] = !1), (e.height[4] = !1)));
  } else if (E(r)) {
    if (F(r)) {
      ((e.width[2] = !1),
        z(r) && ((e.height[0] = !1), (e.height[1] = !1), (e.height[3] = !1), (e.height[4] = !1)));
      let n = i.get(r.parentid);
      ie(n) && (e.height[2] = !1);
    }
    r.children.length === 0 && ((e.width[2] = !1), (e.height[2] = !1));
  } else E(r) || ne(r) || ae(r) || ((e.width[2] = !1), ue(r) || (e.height[2] = !1));
  return (
    Y(r) && K(r.layout) && te(r) && !me(r) && ((e.width[2] = !1), (e.height[2] = !1)),
    ye(i, r) || ((e.width[4] = !1), (e.height[4] = !1)),
    ((F(o) && ge(o) && q(o.heightType)) || z(o)) && ((e.height[3] = !1), (e.height[1] = !1)),
    R(o) && ((e.width[3] = !1), (e.width[1] = !1), (e.height[3] = !1), (e.height[1] = !1)),
    e
  );
}
var Ue = "https://app.framerstatic.com/icon-basicons-NRZARW5S.svg";
var Ge = "https://app.framerstatic.com/icon-feather-LEEKEZZV.svg";
var De = "https://app.framerstatic.com/icon-flowbite-SWNS37K5.svg";
var We = "https://app.framerstatic.com/icon-hero-MOIMWJ5M.svg";
var Ee = "https://app.framerstatic.com/icon-iconic-RSBR2SQV.svg";
var Oe = "https://app.framerstatic.com/icon-lucide-2M6GABE3.svg";
var ze = "https://app.framerstatic.com/icon-mage-WFBLEETK.svg";
var He = "https://app.framerstatic.com/icon-material-ZFYKS3Z5.svg";
var Be = "https://app.framerstatic.com/icon-meteor-CJQWIC4B.svg";
var je = "https://app.framerstatic.com/icon-nonicons-P25FMITH.svg";
var Ze = "https://app.framerstatic.com/icon-phosphor-X6MP62ER.svg";
var _e = "https://app.framerstatic.com/icon-sargam-VNIYTXJC.svg";
var l = j(_(), 1);
function qe() {
  return (0, l.jsx)("svg", {
...
var Et = [
  ...
  bi = new Set(Et.map((i) => i.vectorSetModuleId));
async function nt(i) {
  try {
    ...
    let { videoWidth: r, videoHeight: o } = t;
          ...
          return (...s) => {
            ...
            return new Promise((c, m) => {
              (i !== void 0 &&
                ...
                r
                  .then((h) => {
                    (window.clearTimeout(d), typeof h[a] == "function" ? c(h[a](...s)) : c(h[a]));
                  })
                  .catch(m));
            });
          };
...
function st(i) {
  let t = i.properties?.image?.width,
    r = i.properties?.image?.height;
  return (
    g(t !== void 0 && r !== void 0, "Image asset missing width/height"),
    { naturalWidth: t, naturalHeight: r }
  );
}
var B = class {
    constructor(t, r) {
    ...
    async uploadImage(
      ...
      try {
        ...
        return s
          ? (a && (await this.assetService.refresh().catch(w)),
            {
              type: "image",
              asset: s,
              filename: v(s),
        ...
        (p({
          ...
          V.reportError(n, { fileName: t.name, fileSize: t.size, fileType: t.type }));
      }
    }
    async uploadVideo(
      t,
      ...
      try {
        let n = r ? H : (m) => p(m),
          s = await Promise.all([
            Bt(nt(t), 1e4, "Measuring the video took more than 10 seconds"),
            this.api.uploadAsset(t, { maxFileSize: o, onExceedsCustomMaxSize: e, onToast: n }),
          ]);
        if (!s) return;
        let [d, c] = s;
        return c
    ...
    async uploadAssetByURL(t, { silent: r = !1, refreshAssetService: o = !0 } = {}) {
      let e = Z(t),
        n =
          (e && this.assetService.getAssetByFilename(e.filename)) ??
          (await this.api.uploadAssetByURL(t, r ? void 0 : p)),
        s = { asset: n, filename: v(n), originalFilename: n.name, url: S(n) };
      return (
        o && (await this.assetService.refresh().catch(w)),
        n.mimeType.startsWith("image/")
          ? { ...s, type: "image", imageSize: st(n) }
          : { ...s, type: "file" }
      );
    }
    async uploadFile(
      ...
      let n = await this.api.uploadAsset(t, {
        maxFileSize: o,
        onExceedsCustomMaxSize: e,
        onToast: r ? void 0 : (s) => p(s),
      });
      if (n)
        return (
          a && (await this.assetService.refresh().catch(w)),
          { type: "file", asset: n, filename: v(n), originalFilename: n.name, url: S(n) }
        );
    }
    async uploadFonts(t, { refreshAssetService: r = !0 } = {}) {
      let o = [];
      if (!t) return o;
      try {
        for (let e of t) {
          let a = await xe(e.content, e.originalFilename),
            n = await this.api.uploadAsset(a);
          !n ||
            !n.properties ||
            o.push({ filename: v(n), originalFontName: n.name, properties: n.properties.font });
        }
        r && (await this.assetService.refresh().catch(w));
      } catch (e) {
        V.warn("Failed to add font:", e);
      }
      return o;
    }
    async uploadImageByURL(t, { refreshAssetService: r = !0 } = {}) {
      let o = [];
      if (!t) return o;
      try {
        let e = await this.uploadAssetByURL(t.url, { refreshAssetService: r });
        (g(zt(e)), o.push(e));
      } catch (e) {
        V.warn("Failed to add image by URL:", e);
      }
      return o;
    }
  },
  { service: Wi, resolve: Ht } = at();
function Ei(i, t) {
  Ht(new B(i, t));
}
function Bt(i, t, r = "timed out") {
...
//# sourceMappingURL=chunk-BLTSRKBK.mjs.map
