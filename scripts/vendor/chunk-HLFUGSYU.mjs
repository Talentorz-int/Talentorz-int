import { a as m } from "chunk-6PNPO5DW.mjs";
import { j as k } from "chunk-XELMBOBL.mjs";
var p = class {
    constructor(e, t) {
      this.name = e;
      this.mode = t;
  ...
  R = class {
    constructor() {
      k(this, "heldLocks", new Set());
      k(this, "lockRequestQueueMap", new Map());
    }
    isLocked(e) {
      return this.heldLocks.has(e);
    }
    request(e, t, o) {
      let { options: r, callback: i } = this.getOptionsAndCallback(t, o),
        n = "exclusive",
        c = f(),
        l = { name: e, mode: n, promise: c, callback: i },
        d = this.ensureRequestQueue(e);
      if (r.signal) {
      ...
      return (d.push(l), this.processRequestQueue(e), c);
    }
...
function P(s, e, t) {
  ...
  return (
    (a[s] = r),
    L.request(s, { signal: r.signal }, async () => {
      let i = new Promise((n, c) => {
        let l = setTimeout(n, e);
      ...
      (await t(r.signal), a[s] === r && delete a[s]);
    })
  );
}
var u = /(?:\.[^.]+)?$/u;
...
export { L as a, P as b, x as c };
//# sourceMappingURL=chunk-HLFUGSYU.mjs.map
